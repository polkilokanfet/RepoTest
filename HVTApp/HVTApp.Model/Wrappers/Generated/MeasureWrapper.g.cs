...
namespace HVTApp.Model.Wrappers
{
  ...
  {
    private MeasureWrapper(IGetWrapper getWrapper) : base(new Measure(), getWrapper) { }
    private MeasureWrapper(Measure model, IGetWrapper getWrapper) : base(model, getWrapper) { }
