...
namespace HVTApp.Model.Wrappers
{
  ...
  {
    private TenderTypeWrapper(IGetWrapper getWrapper) : base(new TenderType(), getWrapper) { }
    private TenderTypeWrapper(TenderType model, IGetWrapper getWrapper) : base(model, getWrapper) { }
