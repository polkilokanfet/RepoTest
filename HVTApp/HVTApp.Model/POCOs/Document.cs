...
namespace HVTApp.Model.POCOs
{
    ...
    public partial class Document : BaseEntity
    {
        ...
        public Guid? WhoRegisteredUserId { get; set; } = GlobalAppProperties.User.Id;
        ...
        {
            return $"Письмо {this.SenderEmployee?.Company} рег.№{RegNumber} от {this.Date.ToShortDateString()} г.";
        }
    }
