...
namespace HVTApp.Model.POCOs
{
    ...
    {
        /// <summary>
        /// Роли, в которых можно перейти на данный этап
        /// </summary>
        ...
        /// <param name="roles">Роль, в которой можно перейти на данный этап</param>
        ...
        {
            public override string Description => "Проверяющий согласовал проработку исполнителю";
        ...
        {
            public override string Description => "Проверяющий отклонил проработку исполнителю";
