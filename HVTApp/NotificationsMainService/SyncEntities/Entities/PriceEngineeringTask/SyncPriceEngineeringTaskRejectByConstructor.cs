...
namespace NotificationsMainService.SyncEntities.Entities
{
    ...
    {
        public SyncPriceEngineeringTaskRejectByConstructor(IEventAggregator eventAggregator, INotificationFromDataBaseService notificationFromDataBaseService, IUnitOfWork unitOfWork, IEventServiceClient eventServiceClient) : base(eventAggregator, notificationFromDataBaseService, unitOfWork, eventServiceClient)
        {
        }
        ...
        protected override ActionPublishThroughEventServiceForUserDelegate ActionPublishThroughEventServiceForUser
        {
            get
            {
                return (eventSourceAppSessionId, targetUserId, targetRole, priceEngineeringTaskId) => EventServiceClient.PriceEngineeringTaskRejectByConstructorPublishEvent(eventSourceAppSessionId, targetUserId, targetRole, priceEngineeringTaskId);
            }
        }
