...
namespace NotificationsMainService.SyncEntities.Entities
{
    public class SyncPriceEngineeringTaskStart : SyncUnit<HVTApp.Model.POCOs.PriceEngineeringTask, PriceEngineeringTaskStartedEvent>
    {
        ...
        protected override ActionPublishThroughEventServiceForUserDelegate ActionPublishThroughEventServiceForUser
        {
            get
            {
                return (eventSourceAppSessionId, targetUserId, targetRole, priceEngineeringTaskId) => EventServiceClient.PriceEngineeringTaskStartPublishEvent(eventSourceAppSessionId, targetUserId, targetRole, priceEngineeringTaskId);
            }
        }
