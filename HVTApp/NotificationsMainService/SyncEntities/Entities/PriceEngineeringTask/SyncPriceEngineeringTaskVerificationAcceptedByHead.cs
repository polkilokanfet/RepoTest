...
namespace NotificationsMainService.SyncEntities.Entities
{
    public class SyncPriceEngineeringTaskVerificationAcceptedByHead : SyncUnit<HVTApp.Model.POCOs.PriceEngineeringTask, PriceEngineeringTaskVerificationAcceptedByHeadEvent>
    {
        ...
        protected override ActionPublishThroughEventServiceForUserDelegate ActionPublishThroughEventServiceForUser
        {
            get
            {
                return (targetUserId, targetRole, priceEngineeringTaskId) => EventServiceClient.PriceEngineeringTaskVerificationAcceptedByHeadPublishEvent(targetUserId, targetRole, priceEngineeringTaskId);
            }
        }
