...
namespace NotificationsMainService.SyncEntities.Entities
{
    public class SyncDirectumTaskAccept: SyncUnit<DirectumTask, AfterAcceptDirectumTaskEvent>
    {
        ...
        protected override ActionPublishThroughEventServiceForUserDelegate ActionPublishThroughEventServiceForUser
        {
            get
            {
                return (eventSourceAppSessionId, targetUserId, targetRole, taskId) => EventServiceClient.AcceptDirectumTaskPublishEvent(eventSourceAppSessionId, targetUserId, targetRole, taskId);
            }
        }
