...
namespace EventServiceClient2.SyncEntities
{
    ...
    {
        public SyncPriceEngineeringTaskStart(IUnityContainer container) : base(container)
        {
        }
        ...
        protected override ActionPublishThroughEventServiceForUserDelegate ActionPublishThroughEventServiceForUser
        {
            get
            {
                return (eventSourceAppSessionId, targetUserId, priceEngineeringTaskId) => EventServiceHost.PriceEngineeringTaskStartPublishEvent(eventSourceAppSessionId, targetUserId, priceEngineeringTaskId);
            }
        }
