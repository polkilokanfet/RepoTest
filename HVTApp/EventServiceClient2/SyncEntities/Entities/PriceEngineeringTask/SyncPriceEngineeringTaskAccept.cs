...
namespace EventServiceClient2.SyncEntities
{
    ...
    {
        public SyncPriceEngineeringTaskAccept(IUnityContainer container) : base(container)
        {
        }
        ...
        protected override ActionPublishThroughEventServiceForUserDelegate ActionPublishThroughEventServiceForUser
        {
            get
            {
                return (eventSourceAppSessionId, targetUserId, priceEngineeringTaskId) => EventServiceHost.PriceEngineeringTaskAcceptPublishEvent(eventSourceAppSessionId, targetUserId, priceEngineeringTaskId);
            }
        }
