...
namespace HVTApp.TestDataGenerator
{
    public partial class TestData
    {
        ...
        {
            SalesUnitVeb1101Full.Clone(new SalesUnit { Project = ProjectStation, Product = ProductVeb110, Order = OrderVeb110, OrderPosition = "1", SerialNumber = "1111", EndProductionPlanDate = DateTime.Today.AddDays(99), ProductionTerm = 90, AssembleTerm = 7, Cost = 3000000, Specification = SpecificationMrsk1, PaymentConditionSet = PaymentConditionSet50Na50, AddressDelivery = AddressSubstation, Facility = FacilityStation, ProductsIncluded = new List<ProductIncluded> { new ProductIncluded { Product = ProductSupervision, Amount = 1 } }, PaymentsActual = new List<PaymentActual> { PaymentActual1 }, PaymentsPlanned = new List<PaymentPlanned> { PaymentPlanned1, PaymentPlanned2, PaymentPlanned3, PaymentPlanned4, PaymentPlanned5 }, Penalty = new Penalty {PercentPerDay = 0.005}, FakeData = new FakeData {Cost = 9999999}, SignalToStartProduction = DateTime.Today });
            SalesUnitVeb1102Full.Clone(new SalesUnit { Project = ProjectStation, Product = ProductVeb110, Order = OrderVeb110, OrderPosition = "2", SerialNumber = "2222", EndProductionPlanDate = DateTime.Today.AddDays(99), ProductionTerm = 90, AssembleTerm = 7, Cost = 3000000, Specification = SpecificationMrsk1, PaymentConditionSet = PaymentConditionSet50Na50, AddressDelivery = AddressSubstation, Facility = FacilityStation, ProductsIncluded = new List<ProductIncluded> { new ProductIncluded { Product = ProductZip1, Amount = 3 } }, PaymentsActual = new List<PaymentActual> { PaymentActual2 }, SignalToStartProduction = DateTime.Today });

            SalesUnitZng1101Full.Clone(new SalesUnit { Project = ProjectStation, Product = ProductZng110, Order = OrderZng110, OrderPosition = "1", SerialNumber = "5555", EndProductionPlanDate = DateTime.Today.AddDays(90), ProductionTerm = 90, AssembleTerm = 7, Cost = 450000, Specification = SpecificationMrsk1, PaymentConditionSet = PaymentConditionSet50Na50, AddressDelivery = AddressSubstation, Facility = FacilityStation, PaymentsActual = new List<PaymentActual> { PaymentActual3 }, SignalToStartProduction = DateTime.Today});
            SalesUnitZng1102Full.Clone(new SalesUnit { Project = ProjectStation, Product = ProductZng110, Order = OrderZng110, OrderPosition = "2", SerialNumber = "6666", EndProductionPlanDate = DateTime.Today.AddDays(90), ProductionTerm = 90, AssembleTerm = 7, Cost = 450000, Specification = SpecificationMrsk1, PaymentConditionSet = PaymentConditionSet50Na50, AddressDelivery = AddressSubstation, Facility = FacilityStation, PaymentsActual = new List<PaymentActual> { PaymentActual4 }, SignalToStartProduction = DateTime.Today });
            SalesUnitZng1103Full.Clone(new SalesUnit { Project = ProjectStation, Product = ProductZng110, Order = OrderZng110, OrderPosition = "3", SerialNumber = "7777", EndProductionPlanDate = DateTime.Today.AddDays(90), ProductionTerm = 90, AssembleTerm = 7, Cost = 450000, Specification = SpecificationMrsk1, PaymentConditionSet = PaymentConditionSet50Na50, AddressDelivery = AddressSubstation, Facility = FacilityStation, PaymentsActual = new List<PaymentActual> { PaymentActual5 }, SignalToStartProduction = DateTime.Today });
        ...
        {
            SpecificationMrsk1.Clone(new Specification { Contract = ContractMrsk, Date = ContractMrsk.Date, Number = "1", Vat = 20 });
            SpecificationFsk.Clone(new Specification { Contract = ContractFsk, Date = ContractFsk.Date, Number = "1", Vat = 20 });
        }
