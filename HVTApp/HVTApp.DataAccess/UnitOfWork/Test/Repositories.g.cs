...
namespace HVTApp.DataAccess
{
    ...
    public partial class PriceCalculationFileRepositoryTest : TestBaseRepository<PriceCalculationFile>, IPriceCalculationFileRepository
    {
    ...
    public partial class PriceEngineeringTasksRepositoryTest : TestBaseRepository<PriceEngineeringTasks>, IPriceEngineeringTasksRepository
    {
        public PriceEngineeringTasksRepositoryTest(TestData testData) : base(testData) {}
    }
    ...
    public partial class ProductCategoryPriceAndCostRepositoryTest : TestBaseRepository<ProductCategoryPriceAndCost>, IProductCategoryPriceAndCostRepository
    {
        public ProductCategoryPriceAndCostRepositoryTest(TestData testData) : base(testData) {}
    }
