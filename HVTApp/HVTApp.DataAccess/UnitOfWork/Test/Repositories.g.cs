...
namespace HVTApp.DataAccess
{
    ...
    public partial class TenderUnitRepositoryTest : TestBaseRepository<TenderUnit>, ITenderUnitRepository
    {
        public TenderUnitRepositoryTest(TestData testData) : base(testData) {}
    }
