...
namespace HVTApp.DataAccess
{
    public partial class HvtAppDataBaseInitializer
    {
        protected void AddData(HvtAppContext context)
        {
            ...
            context.DesignDepartmentParametersSubTaskDbSet.AddRange(testData.GetAll<DesignDepartmentParametersSubTask>());
            ...
            context.PriceEngineeringTaskNumberDbSet.AddRange(testData.GetAll<PriceEngineeringTaskNumber>());
            ...
            context.PriceEngineeringTasksNumberDbSet.AddRange(testData.GetAll<PriceEngineeringTasksNumber>());
