...
namespace HVTApp.DataAccess
{
    public partial class HvtAppDataBaseInitializer
    {
        protected void AddData(HvtAppContext context)
        {
            ...
            context.NotificationsReportsSettingsDbSet.AddRange(testData.GetAll<NotificationsReportsSettings>());
            ...
            context.UpdateStructureCostNumberTaskDbSet.AddRange(testData.GetAll<UpdateStructureCostNumberTask>());
