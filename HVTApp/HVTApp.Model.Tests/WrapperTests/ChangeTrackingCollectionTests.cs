...
namespace HVTApp.Model.Tests.WrapperTests
{
  ...
  public class ChangeTrackingCollectionTests
  {
    ...
    public void Initialize()
    {
      ...
      {
        _testWrappersFactory.GetWrapper<TestFriendEmailWrapper>(new TestFriendEmail {Email="thomas@thomasclaudiushuber.com" }),
        _testWrappersFactory.GetWrapper<TestFriendEmailWrapper>(new TestFriendEmail {Email="julia@juhu-design.com" }),
       };
    }
    ...
    public void ShouldAcceptChanges()
    {
      ...
      var emailToAdd = _testWrappersFactory.GetWrapper<TestFriendEmailWrapper>(new TestFriendEmail { Email = "anotherOne@thomasclaudiushuber.com" });
