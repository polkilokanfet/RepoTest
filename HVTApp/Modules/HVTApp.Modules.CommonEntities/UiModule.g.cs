...
namespace HVTApp.UI
{
    public partial class UiModule : ModuleBase
    {
		private void RegisterViews()
        {
			...
			_selectService.Register<StandartPaymentConditionsListView, StandartPaymentConditions>();
			...
			_selectService.Register<ExchangeCurrencyRateListView, ExchangeCurrencyRate>();
