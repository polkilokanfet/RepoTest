...
{
    public class SalesUnitsGroup : SalesUnitWrapper
    {
        ...
        public DateTime DeliveryDateExpectedG
        {
            get { return DeliveryDateExpected; }
            set
            {
                if (DeliveryDateExpected == value) return;
                if(value < DateTime.Today) return;
                DeliveryDateExpected = value;
                OnPropertyChanged();
            }
        }
