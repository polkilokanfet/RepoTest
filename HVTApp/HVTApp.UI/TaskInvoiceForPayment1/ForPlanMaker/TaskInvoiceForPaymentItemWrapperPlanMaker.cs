...
{
    public class TaskInvoiceForPaymentItemWrapperPlanMaker : TaskInvoiceForPaymentItemWrapperBase
    {
        public override string Order
        {
            get => this.SalesUnits
                .Where(x => x.Order != null)
                .Select(x => x.Order.Number)
                .Distinct()
                .ToStringEnum();
            set
            {
        ...
        public TaskInvoiceForPaymentItemWrapperPlanMaker(TaskInvoiceForPaymentItem model) : base(model)
        {
            foreach (var salesUnit in this.SalesUnits)
            {
