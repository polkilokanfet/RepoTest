...
namespace HVTApp.UI.Views
{
    ...
    public partial class DesignDepartmentDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.DesignDepartment).GetProperty(nameof(HVTApp.Model.POCOs.DesignDepartment.Observers)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityObserversDesignDepartment = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.DesignDepartment).GetProperty(nameof(HVTApp.Model.POCOs.DesignDepartment.ParameterSetsSubTask)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
        ...
        public static readonly DependencyProperty VisibilityObserversDesignDepartmentProperty = DependencyProperty.Register("VisibilityObserversDesignDepartment", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityObserversDesignDepartment
        {
            get { return (Visibility) GetValue(VisibilityObserversDesignDepartmentProperty); }
            set { SetValue(VisibilityObserversDesignDepartmentProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityParameterSetsSubTaskDesignDepartmentProperty = DependencyProperty.Register("VisibilityParameterSetsSubTaskDesignDepartment", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityParameterSetsSubTaskDesignDepartment
        {
    ...
    public partial class PaymentActualDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilitySalesUnitIdPaymentActual = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PaymentActual).GetProperty(nameof(HVTApp.Model.POCOs.PaymentActual.PaymentDocumentId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPaymentDocumentIdPaymentActual = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilitySalesUnitIdPaymentActualProperty = DependencyProperty.Register("VisibilitySalesUnitIdPaymentActual", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilitySalesUnitIdPaymentActual
        {
            get { return (Visibility) GetValue(VisibilitySalesUnitIdPaymentActualProperty); }
            set { SetValue(VisibilitySalesUnitIdPaymentActualProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityPaymentDocumentIdPaymentActualProperty = DependencyProperty.Register("VisibilityPaymentDocumentIdPaymentActual", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPaymentDocumentIdPaymentActual
        {
            get { return (Visibility) GetValue(VisibilityPaymentDocumentIdPaymentActualProperty); }
            set { SetValue(VisibilityPaymentDocumentIdPaymentActualProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class PriceCalculationDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceCalculation).GetProperty(nameof(HVTApp.Model.POCOs.PriceCalculation.PriceEngineeringTasksId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPriceEngineeringTasksIdPriceCalculation = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceCalculation).GetProperty(nameof(HVTApp.Model.POCOs.PriceCalculation.IsTceConnected)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsTceConnectedPriceCalculation = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityPriceEngineeringTasksIdPriceCalculationProperty = DependencyProperty.Register("VisibilityPriceEngineeringTasksIdPriceCalculation", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceEngineeringTasksIdPriceCalculation
        {
            get { return (Visibility) GetValue(VisibilityPriceEngineeringTasksIdPriceCalculationProperty); }
            set { SetValue(VisibilityPriceEngineeringTasksIdPriceCalculationProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsTceConnectedPriceCalculationProperty = DependencyProperty.Register("VisibilityIsTceConnectedPriceCalculation", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsTceConnectedPriceCalculation
        {
            get { return (Visibility) GetValue(VisibilityIsTceConnectedPriceCalculationProperty); }
            set { SetValue(VisibilityIsTceConnectedPriceCalculationProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class PriceCalculationItemDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceCalculationItem).GetProperty(nameof(HVTApp.Model.POCOs.PriceCalculationItem.PriceCalculation)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPriceCalculationPriceCalculationItem = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceCalculationItem).GetProperty(nameof(HVTApp.Model.POCOs.PriceCalculationItem.PriceEngineeringTaskId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPriceEngineeringTaskIdPriceCalculationItem = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceCalculationItem).GetProperty(nameof(HVTApp.Model.POCOs.PriceCalculationItem.PositionInTeamCenter)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPositionInTeamCenterPriceCalculationItem = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceCalculationItem).GetProperty(nameof(HVTApp.Model.POCOs.PriceCalculationItem.FinishDate)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityFinishDatePriceCalculationItem = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityPriceCalculationPriceCalculationItemProperty = DependencyProperty.Register("VisibilityPriceCalculationPriceCalculationItem", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceCalculationPriceCalculationItem
        {
            get { return (Visibility) GetValue(VisibilityPriceCalculationPriceCalculationItemProperty); }
            set { SetValue(VisibilityPriceCalculationPriceCalculationItemProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityPriceEngineeringTaskIdPriceCalculationItemProperty = DependencyProperty.Register("VisibilityPriceEngineeringTaskIdPriceCalculationItem", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceEngineeringTaskIdPriceCalculationItem
        {
            get { return (Visibility) GetValue(VisibilityPriceEngineeringTaskIdPriceCalculationItemProperty); }
            set { SetValue(VisibilityPriceEngineeringTaskIdPriceCalculationItemProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityPositionInTeamCenterPriceCalculationItemProperty = DependencyProperty.Register("VisibilityPositionInTeamCenterPriceCalculationItem", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPositionInTeamCenterPriceCalculationItem
        {
            get { return (Visibility) GetValue(VisibilityPositionInTeamCenterPriceCalculationItemProperty); }
            set { SetValue(VisibilityPositionInTeamCenterPriceCalculationItemProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityFinishDatePriceCalculationItemProperty = DependencyProperty.Register("VisibilityFinishDatePriceCalculationItem", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityFinishDatePriceCalculationItem
        {
            get { return (Visibility) GetValue(VisibilityFinishDatePriceCalculationItemProperty); }
            set { SetValue(VisibilityFinishDatePriceCalculationItemProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class DesignDepartmentParametersSubTaskDetailsView : ViewBase
    {
        public DesignDepartmentParametersSubTaskDetailsView()
        {
			InitializeComponent();
        }

        public DesignDepartmentParametersSubTaskDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, DesignDepartmentParametersSubTaskDetailsViewModel DesignDepartmentParametersSubTaskDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = DesignDepartmentParametersSubTaskDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.DesignDepartmentParametersSubTask).GetProperty(nameof(HVTApp.Model.POCOs.DesignDepartmentParametersSubTask.DesignDepartmentId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityDesignDepartmentIdDesignDepartmentParametersSubTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.DesignDepartmentParametersSubTask).GetProperty(nameof(HVTApp.Model.POCOs.DesignDepartmentParametersSubTask.Name)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityNameDesignDepartmentParametersSubTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.DesignDepartmentParametersSubTask).GetProperty(nameof(HVTApp.Model.POCOs.DesignDepartmentParametersSubTask.Parameters)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityParametersDesignDepartmentParametersSubTask = Visibility.Collapsed;


        }


        public static readonly DependencyProperty VisibilityDesignDepartmentIdDesignDepartmentParametersSubTaskProperty = DependencyProperty.Register("VisibilityDesignDepartmentIdDesignDepartmentParametersSubTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityDesignDepartmentIdDesignDepartmentParametersSubTask
        {
            get { return (Visibility) GetValue(VisibilityDesignDepartmentIdDesignDepartmentParametersSubTaskProperty); }
            set { SetValue(VisibilityDesignDepartmentIdDesignDepartmentParametersSubTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityNameDesignDepartmentParametersSubTaskProperty = DependencyProperty.Register("VisibilityNameDesignDepartmentParametersSubTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityNameDesignDepartmentParametersSubTask
        {
            get { return (Visibility) GetValue(VisibilityNameDesignDepartmentParametersSubTaskProperty); }
            set { SetValue(VisibilityNameDesignDepartmentParametersSubTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityParametersDesignDepartmentParametersSubTaskProperty = DependencyProperty.Register("VisibilityParametersDesignDepartmentParametersSubTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityParametersDesignDepartmentParametersSubTask
        {
            get { return (Visibility) GetValue(VisibilityParametersDesignDepartmentParametersSubTaskProperty); }
            set { SetValue(VisibilityParametersDesignDepartmentParametersSubTaskProperty, value); OnPropertyChanged(); }
        }

	}

    public partial class NotificationsReportsSettingsDetailsView : ViewBase
    {
        public NotificationsReportsSettingsDetailsView()
        {
			InitializeComponent();
        }

        public NotificationsReportsSettingsDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, NotificationsReportsSettingsDetailsViewModel NotificationsReportsSettingsDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = NotificationsReportsSettingsDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.NotificationsReportsSettings).GetProperty(nameof(HVTApp.Model.POCOs.NotificationsReportsSettings.ChiefEngineerReportMoment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityChiefEngineerReportMomentNotificationsReportsSettings = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.NotificationsReportsSettings).GetProperty(nameof(HVTApp.Model.POCOs.NotificationsReportsSettings.ChiefEngineerReportDistributionList)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
        ...
        public static readonly DependencyProperty VisibilityChiefEngineerReportMomentNotificationsReportsSettingsProperty = DependencyProperty.Register("VisibilityChiefEngineerReportMomentNotificationsReportsSettings", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityChiefEngineerReportMomentNotificationsReportsSettings
        {
            get { return (Visibility) GetValue(VisibilityChiefEngineerReportMomentNotificationsReportsSettingsProperty); }
            set { SetValue(VisibilityChiefEngineerReportMomentNotificationsReportsSettingsProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityChiefEngineerReportDistributionListNotificationsReportsSettingsProperty = DependencyProperty.Register("VisibilityChiefEngineerReportDistributionListNotificationsReportsSettings", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityChiefEngineerReportDistributionListNotificationsReportsSettings
        {
    ...
    public partial class PriceEngineeringTaskDetailsView : ViewBase
    {
        public PriceEngineeringTaskDetailsView()
        {
			InitializeComponent();
        }

        public PriceEngineeringTaskDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, PriceEngineeringTaskDetailsViewModel PriceEngineeringTaskDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = PriceEngineeringTaskDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.Number)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityNumberPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.ParentPriceEngineeringTasksId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityParentPriceEngineeringTasksIdPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.DesignDepartment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityDesignDepartmentPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.UserConstructor)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityUserConstructorPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.UserPlanMaker)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityUserPlanMakerPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.UserConstructorInspector)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityUserConstructorInspectorPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.UserConstructorInitiator)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityUserConstructorInitiatorPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.Amount)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityAmountPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.ProductBlockManager)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityProductBlockManagerPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.ProductBlockEngineer)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityProductBlockEngineerPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.ProductBlocksAdded)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityProductBlocksAddedPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.ProductBlocksAddedActual)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityProductBlocksAddedActualPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.FilesTechnicalRequirements)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityFilesTechnicalRequirementsPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.FilesAnswers)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityFilesAnswersPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.Messages)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityMessagesPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.ParentPriceEngineeringTaskId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityParentPriceEngineeringTaskIdPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.ChildPriceEngineeringTasks)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityChildPriceEngineeringTasksPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.StructureCostVersions)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityStructureCostVersionsPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.PriceCalculationItems)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPriceCalculationItemsPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.TermPriority)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityTermPriorityPriceEngineeringTask = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.SalesUnits)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.VerificationIsRequested)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityVerificationIsRequestedPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.IsValidForProduction)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsValidForProductionPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.TcePosition)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityTcePositionPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.UpdateStructureCostNumberTasks)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityUpdateStructureCostNumberTasksPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.HasAnyUpdateStructureCostNumberTaskNotFinished)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityHasAnyUpdateStructureCostNumberTaskNotFinishedPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.NeedDesignDocumentationDevelopment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityNeedDesignDocumentationDevelopmentPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.DaysToDesignDocumentationDevelopment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityDaysToDesignDocumentationDevelopmentPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.DesignDocumentationAvailabilityComment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityDesignDocumentationAvailabilityCommentPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.NeedEquipment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityNeedEquipmentPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.IsUploadedDocumentationToTeamCenter)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsUploadedDocumentationToTeamCenterPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.Specification)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilitySpecificationPriceEngineeringTask = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.IsInProcessByConstructor)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsInProcessByConstructorPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.IsFinishedByConstructor)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsFinishedByConstructorPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.IsAccepted)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsAcceptedPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.IsAcceptedTotal)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsAcceptedTotalPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.IsStoppedTotal)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsStoppedTotalPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.StatusesAll)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityStatusesAllPriceEngineeringTask = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.IsStarted)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsStartedPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.AllProductBlocksHasSccNumbersInTce)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityAllProductBlocksHasSccNumbersInTcePriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.ProductBlock)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityProductBlockPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.HasDesignDocumentationInfo)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityHasDesignDocumentationInfoPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.IsFinishedByDesignDepartment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsFinishedByDesignDepartmentPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.MomentFinishByDesignDepartment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityMomentFinishByDesignDepartmentPriceEngineeringTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTask).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTask.IsTop)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsTopPriceEngineeringTask = Visibility.Collapsed;


        }


        public static readonly DependencyProperty VisibilityNumberPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityNumberPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityNumberPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityNumberPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityNumberPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityParentPriceEngineeringTasksIdPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityParentPriceEngineeringTasksIdPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityParentPriceEngineeringTasksIdPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityParentPriceEngineeringTasksIdPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityParentPriceEngineeringTasksIdPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityDesignDepartmentPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityDesignDepartmentPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityDesignDepartmentPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityDesignDepartmentPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityDesignDepartmentPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityUserConstructorPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityUserConstructorPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityUserConstructorPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityUserConstructorPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityUserConstructorPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityUserPlanMakerPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityUserPlanMakerPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityUserPlanMakerPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityUserPlanMakerPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityUserPlanMakerPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityUserConstructorInspectorPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityUserConstructorInspectorPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityUserConstructorInspectorPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityUserConstructorInspectorPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityUserConstructorInspectorPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityUserConstructorInitiatorPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityUserConstructorInitiatorPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityUserConstructorInitiatorPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityUserConstructorInitiatorPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityUserConstructorInitiatorPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityAmountPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityAmountPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityAmountPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityAmountPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityAmountPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityProductBlockManagerPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityProductBlockManagerPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityProductBlockManagerPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityProductBlockManagerPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityProductBlockManagerPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityProductBlockEngineerPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityProductBlockEngineerPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityProductBlockEngineerPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityProductBlockEngineerPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityProductBlockEngineerPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityProductBlocksAddedPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityProductBlocksAddedPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityProductBlocksAddedPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityProductBlocksAddedPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityProductBlocksAddedPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityProductBlocksAddedActualPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityProductBlocksAddedActualPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityProductBlocksAddedActualPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityProductBlocksAddedActualPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityProductBlocksAddedActualPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityFilesTechnicalRequirementsPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityFilesTechnicalRequirementsPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityFilesTechnicalRequirementsPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityFilesTechnicalRequirementsPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityFilesTechnicalRequirementsPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityFilesAnswersPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityFilesAnswersPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityFilesAnswersPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityFilesAnswersPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityFilesAnswersPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityMessagesPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityMessagesPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityMessagesPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityMessagesPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityMessagesPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityParentPriceEngineeringTaskIdPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityParentPriceEngineeringTaskIdPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityParentPriceEngineeringTaskIdPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityParentPriceEngineeringTaskIdPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityParentPriceEngineeringTaskIdPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityChildPriceEngineeringTasksPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityChildPriceEngineeringTasksPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityChildPriceEngineeringTasksPriceEngineeringTask
        {
        ...
        public static readonly DependencyProperty VisibilityStructureCostVersionsPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityStructureCostVersionsPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityStructureCostVersionsPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityStructureCostVersionsPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityStructureCostVersionsPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityPriceCalculationItemsPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityPriceCalculationItemsPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceCalculationItemsPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityPriceCalculationItemsPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityPriceCalculationItemsPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityTermPriorityPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityTermPriorityPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityTermPriorityPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityTermPriorityPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityTermPriorityPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityStatusesPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityStatusesPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityStatusesPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityStatusesPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityStatusesPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilitySalesUnitsPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilitySalesUnitsPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilitySalesUnitsPriceEngineeringTask
        {
        ...
        public static readonly DependencyProperty VisibilityVerificationIsRequestedPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityVerificationIsRequestedPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityVerificationIsRequestedPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityVerificationIsRequestedPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityVerificationIsRequestedPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsValidForProductionPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityIsValidForProductionPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsValidForProductionPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityIsValidForProductionPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityIsValidForProductionPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityTcePositionPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityTcePositionPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityTcePositionPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityTcePositionPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityTcePositionPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityUpdateStructureCostNumberTasksPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityUpdateStructureCostNumberTasksPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityUpdateStructureCostNumberTasksPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityUpdateStructureCostNumberTasksPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityUpdateStructureCostNumberTasksPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityHasAnyUpdateStructureCostNumberTaskNotFinishedPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityHasAnyUpdateStructureCostNumberTaskNotFinishedPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityHasAnyUpdateStructureCostNumberTaskNotFinishedPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityHasAnyUpdateStructureCostNumberTaskNotFinishedPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityHasAnyUpdateStructureCostNumberTaskNotFinishedPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityNeedDesignDocumentationDevelopmentPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityNeedDesignDocumentationDevelopmentPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityNeedDesignDocumentationDevelopmentPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityNeedDesignDocumentationDevelopmentPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityNeedDesignDocumentationDevelopmentPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityDaysToDesignDocumentationDevelopmentPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityDaysToDesignDocumentationDevelopmentPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityDaysToDesignDocumentationDevelopmentPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityDaysToDesignDocumentationDevelopmentPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityDaysToDesignDocumentationDevelopmentPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityDesignDocumentationAvailabilityCommentPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityDesignDocumentationAvailabilityCommentPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityDesignDocumentationAvailabilityCommentPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityDesignDocumentationAvailabilityCommentPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityDesignDocumentationAvailabilityCommentPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityNeedEquipmentPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityNeedEquipmentPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityNeedEquipmentPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityNeedEquipmentPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityNeedEquipmentPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsUploadedDocumentationToTeamCenterPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityIsUploadedDocumentationToTeamCenterPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsUploadedDocumentationToTeamCenterPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityIsUploadedDocumentationToTeamCenterPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityIsUploadedDocumentationToTeamCenterPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilitySpecificationPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilitySpecificationPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilitySpecificationPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilitySpecificationPriceEngineeringTaskProperty); }
            set { SetValue(VisibilitySpecificationPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityIsInProcessByConstructorPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityIsInProcessByConstructorPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsInProcessByConstructorPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityIsInProcessByConstructorPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityIsInProcessByConstructorPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsFinishedByConstructorPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityIsFinishedByConstructorPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsFinishedByConstructorPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityIsFinishedByConstructorPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityIsFinishedByConstructorPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsAcceptedPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityIsAcceptedPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsAcceptedPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityIsAcceptedPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityIsAcceptedPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsAcceptedTotalPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityIsAcceptedTotalPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsAcceptedTotalPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityIsAcceptedTotalPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityIsAcceptedTotalPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsStoppedTotalPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityIsStoppedTotalPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsStoppedTotalPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityIsStoppedTotalPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityIsStoppedTotalPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityStatusesAllPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityStatusesAllPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityStatusesAllPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityStatusesAllPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityStatusesAllPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityStartMomentPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityStartMomentPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityStartMomentPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityStartMomentPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityStartMomentPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsStartedPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityIsStartedPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsStartedPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityIsStartedPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityIsStartedPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityAllProductBlocksHasSccNumbersInTcePriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityAllProductBlocksHasSccNumbersInTcePriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityAllProductBlocksHasSccNumbersInTcePriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityAllProductBlocksHasSccNumbersInTcePriceEngineeringTaskProperty); }
            set { SetValue(VisibilityAllProductBlocksHasSccNumbersInTcePriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityProductBlockPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityProductBlockPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityProductBlockPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityProductBlockPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityProductBlockPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityHasDesignDocumentationInfoPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityHasDesignDocumentationInfoPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityHasDesignDocumentationInfoPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityHasDesignDocumentationInfoPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityHasDesignDocumentationInfoPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsFinishedByDesignDepartmentPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityIsFinishedByDesignDepartmentPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsFinishedByDesignDepartmentPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityIsFinishedByDesignDepartmentPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityIsFinishedByDesignDepartmentPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityMomentFinishByDesignDepartmentPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityMomentFinishByDesignDepartmentPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityMomentFinishByDesignDepartmentPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityMomentFinishByDesignDepartmentPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityMomentFinishByDesignDepartmentPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsTopPriceEngineeringTaskProperty = DependencyProperty.Register("VisibilityIsTopPriceEngineeringTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsTopPriceEngineeringTask
        {
            get { return (Visibility) GetValue(VisibilityIsTopPriceEngineeringTaskProperty); }
            set { SetValue(VisibilityIsTopPriceEngineeringTaskProperty, value); OnPropertyChanged(); }
        }

	}

    public partial class PriceEngineeringTaskFileAnswerDetailsView : ViewBase
    {
        public PriceEngineeringTaskFileAnswerDetailsView()
        {
			InitializeComponent();
        }

        public PriceEngineeringTaskFileAnswerDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, PriceEngineeringTaskFileAnswerDetailsViewModel PriceEngineeringTaskFileAnswerDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = PriceEngineeringTaskFileAnswerDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskFileAnswer).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskFileAnswer.PriceEngineeringTaskId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPriceEngineeringTaskIdPriceEngineeringTaskFileAnswer = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskFileAnswer).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskFileAnswer.IsActual)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsActualPriceEngineeringTaskFileAnswer = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskFileAnswer).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskFileAnswer.CreationMoment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityCreationMomentPriceEngineeringTaskFileAnswer = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskFileAnswer).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskFileAnswer.Name)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityNamePriceEngineeringTaskFileAnswer = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskFileAnswer).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskFileAnswer.Comment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityCommentPriceEngineeringTaskFileAnswer = Visibility.Collapsed;


        }


        public static readonly DependencyProperty VisibilityPriceEngineeringTaskIdPriceEngineeringTaskFileAnswerProperty = DependencyProperty.Register("VisibilityPriceEngineeringTaskIdPriceEngineeringTaskFileAnswer", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceEngineeringTaskIdPriceEngineeringTaskFileAnswer
        {
            get { return (Visibility) GetValue(VisibilityPriceEngineeringTaskIdPriceEngineeringTaskFileAnswerProperty); }
            set { SetValue(VisibilityPriceEngineeringTaskIdPriceEngineeringTaskFileAnswerProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsActualPriceEngineeringTaskFileAnswerProperty = DependencyProperty.Register("VisibilityIsActualPriceEngineeringTaskFileAnswer", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsActualPriceEngineeringTaskFileAnswer
        {
            get { return (Visibility) GetValue(VisibilityIsActualPriceEngineeringTaskFileAnswerProperty); }
            set { SetValue(VisibilityIsActualPriceEngineeringTaskFileAnswerProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityCreationMomentPriceEngineeringTaskFileAnswerProperty = DependencyProperty.Register("VisibilityCreationMomentPriceEngineeringTaskFileAnswer", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityCreationMomentPriceEngineeringTaskFileAnswer
        {
            get { return (Visibility) GetValue(VisibilityCreationMomentPriceEngineeringTaskFileAnswerProperty); }
            set { SetValue(VisibilityCreationMomentPriceEngineeringTaskFileAnswerProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityNamePriceEngineeringTaskFileAnswerProperty = DependencyProperty.Register("VisibilityNamePriceEngineeringTaskFileAnswer", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityNamePriceEngineeringTaskFileAnswer
        {
            get { return (Visibility) GetValue(VisibilityNamePriceEngineeringTaskFileAnswerProperty); }
            set { SetValue(VisibilityNamePriceEngineeringTaskFileAnswerProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityCommentPriceEngineeringTaskFileAnswerProperty = DependencyProperty.Register("VisibilityCommentPriceEngineeringTaskFileAnswer", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityCommentPriceEngineeringTaskFileAnswer
        {
            get { return (Visibility) GetValue(VisibilityCommentPriceEngineeringTaskFileAnswerProperty); }
            set { SetValue(VisibilityCommentPriceEngineeringTaskFileAnswerProperty, value); OnPropertyChanged(); }
        }

	}

    public partial class PriceEngineeringTaskFileTechnicalRequirementsDetailsView : ViewBase
    {
        public PriceEngineeringTaskFileTechnicalRequirementsDetailsView()
        {
			InitializeComponent();
        }

        public PriceEngineeringTaskFileTechnicalRequirementsDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, PriceEngineeringTaskFileTechnicalRequirementsDetailsViewModel PriceEngineeringTaskFileTechnicalRequirementsDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = PriceEngineeringTaskFileTechnicalRequirementsDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityCreationMomentPriceEngineeringTaskFileTechnicalRequirements = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskFileTechnicalRequirements).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskFileTechnicalRequirements.Name)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityNamePriceEngineeringTaskFileTechnicalRequirements = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskFileTechnicalRequirements).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskFileTechnicalRequirements.Comment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityCommentPriceEngineeringTaskFileTechnicalRequirements = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityCreationMomentPriceEngineeringTaskFileTechnicalRequirementsProperty = DependencyProperty.Register("VisibilityCreationMomentPriceEngineeringTaskFileTechnicalRequirements", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityCreationMomentPriceEngineeringTaskFileTechnicalRequirements
        {
            get { return (Visibility) GetValue(VisibilityCreationMomentPriceEngineeringTaskFileTechnicalRequirementsProperty); }
            set { SetValue(VisibilityCreationMomentPriceEngineeringTaskFileTechnicalRequirementsProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityNamePriceEngineeringTaskFileTechnicalRequirementsProperty = DependencyProperty.Register("VisibilityNamePriceEngineeringTaskFileTechnicalRequirements", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityNamePriceEngineeringTaskFileTechnicalRequirements
        {
            get { return (Visibility) GetValue(VisibilityNamePriceEngineeringTaskFileTechnicalRequirementsProperty); }
            set { SetValue(VisibilityNamePriceEngineeringTaskFileTechnicalRequirementsProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityCommentPriceEngineeringTaskFileTechnicalRequirementsProperty = DependencyProperty.Register("VisibilityCommentPriceEngineeringTaskFileTechnicalRequirements", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityCommentPriceEngineeringTaskFileTechnicalRequirements
        {
            get { return (Visibility) GetValue(VisibilityCommentPriceEngineeringTaskFileTechnicalRequirementsProperty); }
            set { SetValue(VisibilityCommentPriceEngineeringTaskFileTechnicalRequirementsProperty, value); OnPropertyChanged(); }
        }

	}

    public partial class PriceEngineeringTaskMessageDetailsView : ViewBase
    {
        public PriceEngineeringTaskMessageDetailsView()
        {
			InitializeComponent();
        }

        public PriceEngineeringTaskMessageDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, PriceEngineeringTaskMessageDetailsViewModel PriceEngineeringTaskMessageDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = PriceEngineeringTaskMessageDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskMessage).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskMessage.PriceEngineeringTaskId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPriceEngineeringTaskIdPriceEngineeringTaskMessage = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskMessage).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskMessage.Author)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityAuthorPriceEngineeringTaskMessage = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskMessage).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskMessage.Moment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityMomentPriceEngineeringTaskMessage = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskMessage).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskMessage.Message)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityMessagePriceEngineeringTaskMessage = Visibility.Collapsed;


        }


        public static readonly DependencyProperty VisibilityPriceEngineeringTaskIdPriceEngineeringTaskMessageProperty = DependencyProperty.Register("VisibilityPriceEngineeringTaskIdPriceEngineeringTaskMessage", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceEngineeringTaskIdPriceEngineeringTaskMessage
        {
            get { return (Visibility) GetValue(VisibilityPriceEngineeringTaskIdPriceEngineeringTaskMessageProperty); }
            set { SetValue(VisibilityPriceEngineeringTaskIdPriceEngineeringTaskMessageProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityAuthorPriceEngineeringTaskMessageProperty = DependencyProperty.Register("VisibilityAuthorPriceEngineeringTaskMessage", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityAuthorPriceEngineeringTaskMessage
        {
            get { return (Visibility) GetValue(VisibilityAuthorPriceEngineeringTaskMessageProperty); }
            set { SetValue(VisibilityAuthorPriceEngineeringTaskMessageProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityMomentPriceEngineeringTaskMessageProperty = DependencyProperty.Register("VisibilityMomentPriceEngineeringTaskMessage", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityMomentPriceEngineeringTaskMessage
        {
            get { return (Visibility) GetValue(VisibilityMomentPriceEngineeringTaskMessageProperty); }
            set { SetValue(VisibilityMomentPriceEngineeringTaskMessageProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityMessagePriceEngineeringTaskMessageProperty = DependencyProperty.Register("VisibilityMessagePriceEngineeringTaskMessage", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityMessagePriceEngineeringTaskMessage
        {
            get { return (Visibility) GetValue(VisibilityMessagePriceEngineeringTaskMessageProperty); }
            set { SetValue(VisibilityMessagePriceEngineeringTaskMessageProperty, value); OnPropertyChanged(); }
        }

	}

    public partial class PriceEngineeringTaskProductBlockAddedDetailsView : ViewBase
    {
        public PriceEngineeringTaskProductBlockAddedDetailsView()
        {
			InitializeComponent();
        }

        public PriceEngineeringTaskProductBlockAddedDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, PriceEngineeringTaskProductBlockAddedDetailsViewModel PriceEngineeringTaskProductBlockAddedDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = PriceEngineeringTaskProductBlockAddedDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskProductBlockAdded).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskProductBlockAdded.PriceEngineeringTaskId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPriceEngineeringTaskIdPriceEngineeringTaskProductBlockAdded = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskProductBlockAdded).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskProductBlockAdded.Amount)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskProductBlockAdded).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskProductBlockAdded.IsRemoved)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsRemovedPriceEngineeringTaskProductBlockAdded = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskProductBlockAdded).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskProductBlockAdded.StructureCostVersions)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityStructureCostVersionsPriceEngineeringTaskProductBlockAdded = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskProductBlockAdded).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskProductBlockAdded.HasSccNumberInTce)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityHasSccNumberInTcePriceEngineeringTaskProductBlockAdded = Visibility.Collapsed;


        }


        public static readonly DependencyProperty VisibilityPriceEngineeringTaskIdPriceEngineeringTaskProductBlockAddedProperty = DependencyProperty.Register("VisibilityPriceEngineeringTaskIdPriceEngineeringTaskProductBlockAdded", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceEngineeringTaskIdPriceEngineeringTaskProductBlockAdded
        {
            get { return (Visibility) GetValue(VisibilityPriceEngineeringTaskIdPriceEngineeringTaskProductBlockAddedProperty); }
            set { SetValue(VisibilityPriceEngineeringTaskIdPriceEngineeringTaskProductBlockAddedProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityAmountPriceEngineeringTaskProductBlockAddedProperty = DependencyProperty.Register("VisibilityAmountPriceEngineeringTaskProductBlockAdded", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityAmountPriceEngineeringTaskProductBlockAdded
        {
        ...
        public static readonly DependencyProperty VisibilityProductBlockPriceEngineeringTaskProductBlockAddedProperty = DependencyProperty.Register("VisibilityProductBlockPriceEngineeringTaskProductBlockAdded", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityProductBlockPriceEngineeringTaskProductBlockAdded
        {
            get { return (Visibility) GetValue(VisibilityProductBlockPriceEngineeringTaskProductBlockAddedProperty); }
            set { SetValue(VisibilityProductBlockPriceEngineeringTaskProductBlockAddedProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsRemovedPriceEngineeringTaskProductBlockAddedProperty = DependencyProperty.Register("VisibilityIsRemovedPriceEngineeringTaskProductBlockAdded", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsRemovedPriceEngineeringTaskProductBlockAdded
        {
            get { return (Visibility) GetValue(VisibilityIsRemovedPriceEngineeringTaskProductBlockAddedProperty); }
            set { SetValue(VisibilityIsRemovedPriceEngineeringTaskProductBlockAddedProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityStructureCostVersionsPriceEngineeringTaskProductBlockAddedProperty = DependencyProperty.Register("VisibilityStructureCostVersionsPriceEngineeringTaskProductBlockAdded", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityStructureCostVersionsPriceEngineeringTaskProductBlockAdded
        {
            get { return (Visibility) GetValue(VisibilityStructureCostVersionsPriceEngineeringTaskProductBlockAddedProperty); }
            set { SetValue(VisibilityStructureCostVersionsPriceEngineeringTaskProductBlockAddedProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityHasSccNumberInTcePriceEngineeringTaskProductBlockAddedProperty = DependencyProperty.Register("VisibilityHasSccNumberInTcePriceEngineeringTaskProductBlockAdded", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityHasSccNumberInTcePriceEngineeringTaskProductBlockAdded
        {
            get { return (Visibility) GetValue(VisibilityHasSccNumberInTcePriceEngineeringTaskProductBlockAddedProperty); }
            set { SetValue(VisibilityHasSccNumberInTcePriceEngineeringTaskProductBlockAddedProperty, value); OnPropertyChanged(); }
        }

	}

    public partial class PriceEngineeringTasksDetailsView : ViewBase
    {
        public PriceEngineeringTasksDetailsView()
        {
			InitializeComponent();
        }

        public PriceEngineeringTasksDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, PriceEngineeringTasksDetailsViewModel PriceEngineeringTasksDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = PriceEngineeringTasksDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasks).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasks.Number)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityNumberPriceEngineeringTasks = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasks).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasks.NumberFull)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityNumberFullPriceEngineeringTasks = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasks).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasks.TceNumber)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityTceNumberPriceEngineeringTasks = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasks).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasks.UserManager)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityUserManagerPriceEngineeringTasks = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasks).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasks.BackManager)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityBackManagerPriceEngineeringTasks = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasks).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasks.Comment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityCommentPriceEngineeringTasks = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasks).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasks.CommentBackOfficeBoss)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityCommentBackOfficeBossPriceEngineeringTasks = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasks).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasks.ChildPriceEngineeringTasks)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityChildPriceEngineeringTasksPriceEngineeringTasks = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasks).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasks.PriceCalculations)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPriceCalculationsPriceEngineeringTasks = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasks).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasks.StatusesAll)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityStatusesAllPriceEngineeringTasks = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasks).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasks.IsAccepted)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsAcceptedPriceEngineeringTasks = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasks).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasks.StartMoment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityStartMomentPriceEngineeringTasks = Visibility.Collapsed;


        }


        public static readonly DependencyProperty VisibilityNumberPriceEngineeringTasksProperty = DependencyProperty.Register("VisibilityNumberPriceEngineeringTasks", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityNumberPriceEngineeringTasks
        {
            get { return (Visibility) GetValue(VisibilityNumberPriceEngineeringTasksProperty); }
            set { SetValue(VisibilityNumberPriceEngineeringTasksProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityNumberFullPriceEngineeringTasksProperty = DependencyProperty.Register("VisibilityNumberFullPriceEngineeringTasks", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityNumberFullPriceEngineeringTasks
        {
            get { return (Visibility) GetValue(VisibilityNumberFullPriceEngineeringTasksProperty); }
            set { SetValue(VisibilityNumberFullPriceEngineeringTasksProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityTceNumberPriceEngineeringTasksProperty = DependencyProperty.Register("VisibilityTceNumberPriceEngineeringTasks", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityTceNumberPriceEngineeringTasks
        {
            get { return (Visibility) GetValue(VisibilityTceNumberPriceEngineeringTasksProperty); }
            set { SetValue(VisibilityTceNumberPriceEngineeringTasksProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityUserManagerPriceEngineeringTasksProperty = DependencyProperty.Register("VisibilityUserManagerPriceEngineeringTasks", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityUserManagerPriceEngineeringTasks
        {
        ...
        public static readonly DependencyProperty VisibilityBackManagerPriceEngineeringTasksProperty = DependencyProperty.Register("VisibilityBackManagerPriceEngineeringTasks", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityBackManagerPriceEngineeringTasks
        {
            get { return (Visibility) GetValue(VisibilityBackManagerPriceEngineeringTasksProperty); }
            set { SetValue(VisibilityBackManagerPriceEngineeringTasksProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityCommentPriceEngineeringTasksProperty = DependencyProperty.Register("VisibilityCommentPriceEngineeringTasks", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityCommentPriceEngineeringTasks
        {
            get { return (Visibility) GetValue(VisibilityCommentPriceEngineeringTasksProperty); }
            set { SetValue(VisibilityCommentPriceEngineeringTasksProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityCommentBackOfficeBossPriceEngineeringTasksProperty = DependencyProperty.Register("VisibilityCommentBackOfficeBossPriceEngineeringTasks", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityCommentBackOfficeBossPriceEngineeringTasks
        {
            get { return (Visibility) GetValue(VisibilityCommentBackOfficeBossPriceEngineeringTasksProperty); }
            set { SetValue(VisibilityCommentBackOfficeBossPriceEngineeringTasksProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityFilesTechnicalRequirementsPriceEngineeringTasksProperty = DependencyProperty.Register("VisibilityFilesTechnicalRequirementsPriceEngineeringTasks", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityFilesTechnicalRequirementsPriceEngineeringTasks
        {
            get { return (Visibility) GetValue(VisibilityFilesTechnicalRequirementsPriceEngineeringTasksProperty); }
            set { SetValue(VisibilityFilesTechnicalRequirementsPriceEngineeringTasksProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityChildPriceEngineeringTasksPriceEngineeringTasksProperty = DependencyProperty.Register("VisibilityChildPriceEngineeringTasksPriceEngineeringTasks", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityChildPriceEngineeringTasksPriceEngineeringTasks
        {
            get { return (Visibility) GetValue(VisibilityChildPriceEngineeringTasksPriceEngineeringTasksProperty); }
            set { SetValue(VisibilityChildPriceEngineeringTasksPriceEngineeringTasksProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityPriceCalculationsPriceEngineeringTasksProperty = DependencyProperty.Register("VisibilityPriceCalculationsPriceEngineeringTasks", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceCalculationsPriceEngineeringTasks
        {
            get { return (Visibility) GetValue(VisibilityPriceCalculationsPriceEngineeringTasksProperty); }
            set { SetValue(VisibilityPriceCalculationsPriceEngineeringTasksProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityStatusesAllPriceEngineeringTasksProperty = DependencyProperty.Register("VisibilityStatusesAllPriceEngineeringTasks", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityStatusesAllPriceEngineeringTasks
        {
            get { return (Visibility) GetValue(VisibilityStatusesAllPriceEngineeringTasksProperty); }
            set { SetValue(VisibilityStatusesAllPriceEngineeringTasksProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsAcceptedPriceEngineeringTasksProperty = DependencyProperty.Register("VisibilityIsAcceptedPriceEngineeringTasks", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsAcceptedPriceEngineeringTasks
        {
            get { return (Visibility) GetValue(VisibilityIsAcceptedPriceEngineeringTasksProperty); }
            set { SetValue(VisibilityIsAcceptedPriceEngineeringTasksProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityStartMomentPriceEngineeringTasksProperty = DependencyProperty.Register("VisibilityStartMomentPriceEngineeringTasks", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityStartMomentPriceEngineeringTasks
        {
            get { return (Visibility) GetValue(VisibilityStartMomentPriceEngineeringTasksProperty); }
            set { SetValue(VisibilityStartMomentPriceEngineeringTasksProperty, value); OnPropertyChanged(); }
        }

	}

    public partial class PriceEngineeringTasksFileTechnicalRequirementsDetailsView : ViewBase
    {
        public PriceEngineeringTasksFileTechnicalRequirementsDetailsView()
        {
			InitializeComponent();
        }

        public PriceEngineeringTasksFileTechnicalRequirementsDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, PriceEngineeringTasksFileTechnicalRequirementsDetailsViewModel PriceEngineeringTasksFileTechnicalRequirementsDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = PriceEngineeringTasksFileTechnicalRequirementsDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsActualPriceEngineeringTasksFileTechnicalRequirements = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasksFileTechnicalRequirements).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasksFileTechnicalRequirements.CreationMoment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityCreationMomentPriceEngineeringTasksFileTechnicalRequirements = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasksFileTechnicalRequirements).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasksFileTechnicalRequirements.Name)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityNamePriceEngineeringTasksFileTechnicalRequirements = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTasksFileTechnicalRequirements).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTasksFileTechnicalRequirements.Comment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityCommentPriceEngineeringTasksFileTechnicalRequirements = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityIsActualPriceEngineeringTasksFileTechnicalRequirementsProperty = DependencyProperty.Register("VisibilityIsActualPriceEngineeringTasksFileTechnicalRequirements", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsActualPriceEngineeringTasksFileTechnicalRequirements
        {
            get { return (Visibility) GetValue(VisibilityIsActualPriceEngineeringTasksFileTechnicalRequirementsProperty); }
            set { SetValue(VisibilityIsActualPriceEngineeringTasksFileTechnicalRequirementsProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityCreationMomentPriceEngineeringTasksFileTechnicalRequirementsProperty = DependencyProperty.Register("VisibilityCreationMomentPriceEngineeringTasksFileTechnicalRequirements", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityCreationMomentPriceEngineeringTasksFileTechnicalRequirements
        {
            get { return (Visibility) GetValue(VisibilityCreationMomentPriceEngineeringTasksFileTechnicalRequirementsProperty); }
            set { SetValue(VisibilityCreationMomentPriceEngineeringTasksFileTechnicalRequirementsProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityNamePriceEngineeringTasksFileTechnicalRequirementsProperty = DependencyProperty.Register("VisibilityNamePriceEngineeringTasksFileTechnicalRequirements", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityNamePriceEngineeringTasksFileTechnicalRequirements
        {
            get { return (Visibility) GetValue(VisibilityNamePriceEngineeringTasksFileTechnicalRequirementsProperty); }
            set { SetValue(VisibilityNamePriceEngineeringTasksFileTechnicalRequirementsProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityCommentPriceEngineeringTasksFileTechnicalRequirementsProperty = DependencyProperty.Register("VisibilityCommentPriceEngineeringTasksFileTechnicalRequirements", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityCommentPriceEngineeringTasksFileTechnicalRequirements
        {
            get { return (Visibility) GetValue(VisibilityCommentPriceEngineeringTasksFileTechnicalRequirementsProperty); }
            set { SetValue(VisibilityCommentPriceEngineeringTasksFileTechnicalRequirementsProperty, value); OnPropertyChanged(); }
        }

	}

    public partial class PriceEngineeringTaskStatusDetailsView : ViewBase
    {
        public PriceEngineeringTaskStatusDetailsView()
        {
			InitializeComponent();
        }

        public PriceEngineeringTaskStatusDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, PriceEngineeringTaskStatusDetailsViewModel PriceEngineeringTaskStatusDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = PriceEngineeringTaskStatusDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskStatus).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskStatus.PriceEngineeringTaskId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPriceEngineeringTaskIdPriceEngineeringTaskStatus = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskStatus).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskStatus.Moment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityMomentPriceEngineeringTaskStatus = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskStatus).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskStatus.Comment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityCommentPriceEngineeringTaskStatus = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.PriceEngineeringTaskStatus).GetProperty(nameof(HVTApp.Model.POCOs.PriceEngineeringTaskStatus.StatusEnum)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityStatusEnumPriceEngineeringTaskStatus = Visibility.Collapsed;


        }


        public static readonly DependencyProperty VisibilityPriceEngineeringTaskIdPriceEngineeringTaskStatusProperty = DependencyProperty.Register("VisibilityPriceEngineeringTaskIdPriceEngineeringTaskStatus", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceEngineeringTaskIdPriceEngineeringTaskStatus
        {
            get { return (Visibility) GetValue(VisibilityPriceEngineeringTaskIdPriceEngineeringTaskStatusProperty); }
            set { SetValue(VisibilityPriceEngineeringTaskIdPriceEngineeringTaskStatusProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityMomentPriceEngineeringTaskStatusProperty = DependencyProperty.Register("VisibilityMomentPriceEngineeringTaskStatus", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityMomentPriceEngineeringTaskStatus
        {
            get { return (Visibility) GetValue(VisibilityMomentPriceEngineeringTaskStatusProperty); }
            set { SetValue(VisibilityMomentPriceEngineeringTaskStatusProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityCommentPriceEngineeringTaskStatusProperty = DependencyProperty.Register("VisibilityCommentPriceEngineeringTaskStatus", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityCommentPriceEngineeringTaskStatus
        {
            get { return (Visibility) GetValue(VisibilityCommentPriceEngineeringTaskStatusProperty); }
            set { SetValue(VisibilityCommentPriceEngineeringTaskStatusProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityStatusEnumPriceEngineeringTaskStatusProperty = DependencyProperty.Register("VisibilityStatusEnumPriceEngineeringTaskStatus", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityStatusEnumPriceEngineeringTaskStatus
        {
            get { return (Visibility) GetValue(VisibilityStatusEnumPriceEngineeringTaskStatusProperty); }
            set { SetValue(VisibilityStatusEnumPriceEngineeringTaskStatusProperty, value); OnPropertyChanged(); }
        }

	}

    public partial class StructureCostVersionDetailsView : ViewBase
    {
        public StructureCostVersionDetailsView()
        {
			InitializeComponent();
        }

        public StructureCostVersionDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, StructureCostVersionDetailsViewModel StructureCostVersionDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = StructureCostVersionDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.StructureCostVersion).GetProperty(nameof(HVTApp.Model.POCOs.StructureCostVersion.PriceEngineeringTaskId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPriceEngineeringTaskIdStructureCostVersion = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.StructureCostVersion).GetProperty(nameof(HVTApp.Model.POCOs.StructureCostVersion.PriceEngineeringTaskProductBlockAddedId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPriceEngineeringTaskProductBlockAddedIdStructureCostVersion = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.StructureCostVersion).GetProperty(nameof(HVTApp.Model.POCOs.StructureCostVersion.OriginalStructureCostNumber)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityOriginalStructureCostNumberStructureCostVersion = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.StructureCostVersion).GetProperty(nameof(HVTApp.Model.POCOs.StructureCostVersion.Version)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityVersionStructureCostVersion = Visibility.Collapsed;


        }


        public static readonly DependencyProperty VisibilityPriceEngineeringTaskIdStructureCostVersionProperty = DependencyProperty.Register("VisibilityPriceEngineeringTaskIdStructureCostVersion", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceEngineeringTaskIdStructureCostVersion
        {
            get { return (Visibility) GetValue(VisibilityPriceEngineeringTaskIdStructureCostVersionProperty); }
            set { SetValue(VisibilityPriceEngineeringTaskIdStructureCostVersionProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityPriceEngineeringTaskProductBlockAddedIdStructureCostVersionProperty = DependencyProperty.Register("VisibilityPriceEngineeringTaskProductBlockAddedIdStructureCostVersion", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceEngineeringTaskProductBlockAddedIdStructureCostVersion
        {
            get { return (Visibility) GetValue(VisibilityPriceEngineeringTaskProductBlockAddedIdStructureCostVersionProperty); }
            set { SetValue(VisibilityPriceEngineeringTaskProductBlockAddedIdStructureCostVersionProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityOriginalStructureCostNumberStructureCostVersionProperty = DependencyProperty.Register("VisibilityOriginalStructureCostNumberStructureCostVersion", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityOriginalStructureCostNumberStructureCostVersion
        {
            get { return (Visibility) GetValue(VisibilityOriginalStructureCostNumberStructureCostVersionProperty); }
            set { SetValue(VisibilityOriginalStructureCostNumberStructureCostVersionProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityVersionStructureCostVersionProperty = DependencyProperty.Register("VisibilityVersionStructureCostVersion", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityVersionStructureCostVersion
        {
            get { return (Visibility) GetValue(VisibilityVersionStructureCostVersionProperty); }
            set { SetValue(VisibilityVersionStructureCostVersionProperty, value); OnPropertyChanged(); }
        }

	}

    public partial class UpdateStructureCostNumberTaskDetailsView : ViewBase
    {
        public UpdateStructureCostNumberTaskDetailsView()
        {
			InitializeComponent();
        }

        public UpdateStructureCostNumberTaskDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, UpdateStructureCostNumberTaskDetailsViewModel UpdateStructureCostNumberTaskDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = UpdateStructureCostNumberTaskDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.UpdateStructureCostNumberTask).GetProperty(nameof(HVTApp.Model.POCOs.UpdateStructureCostNumberTask.MomentStart)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityMomentStartUpdateStructureCostNumberTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.UpdateStructureCostNumberTask).GetProperty(nameof(HVTApp.Model.POCOs.UpdateStructureCostNumberTask.MomentFinish)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityMomentFinishUpdateStructureCostNumberTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.UpdateStructureCostNumberTask).GetProperty(nameof(HVTApp.Model.POCOs.UpdateStructureCostNumberTask.ProductBlock)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityProductBlockUpdateStructureCostNumberTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.UpdateStructureCostNumberTask).GetProperty(nameof(HVTApp.Model.POCOs.UpdateStructureCostNumberTask.StructureCostNumberOriginal)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityStructureCostNumberOriginalUpdateStructureCostNumberTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.UpdateStructureCostNumberTask).GetProperty(nameof(HVTApp.Model.POCOs.UpdateStructureCostNumberTask.StructureCostNumber)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityStructureCostNumberUpdateStructureCostNumberTask = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.UpdateStructureCostNumberTask).GetProperty(nameof(HVTApp.Model.POCOs.UpdateStructureCostNumberTask.IsAccepted)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsAcceptedUpdateStructureCostNumberTask = Visibility.Collapsed;


        }


        public static readonly DependencyProperty VisibilityMomentStartUpdateStructureCostNumberTaskProperty = DependencyProperty.Register("VisibilityMomentStartUpdateStructureCostNumberTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityMomentStartUpdateStructureCostNumberTask
        {
            get { return (Visibility) GetValue(VisibilityMomentStartUpdateStructureCostNumberTaskProperty); }
            set { SetValue(VisibilityMomentStartUpdateStructureCostNumberTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityMomentFinishUpdateStructureCostNumberTaskProperty = DependencyProperty.Register("VisibilityMomentFinishUpdateStructureCostNumberTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityMomentFinishUpdateStructureCostNumberTask
        {
            get { return (Visibility) GetValue(VisibilityMomentFinishUpdateStructureCostNumberTaskProperty); }
            set { SetValue(VisibilityMomentFinishUpdateStructureCostNumberTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityProductBlockUpdateStructureCostNumberTaskProperty = DependencyProperty.Register("VisibilityProductBlockUpdateStructureCostNumberTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityProductBlockUpdateStructureCostNumberTask
        {
            get { return (Visibility) GetValue(VisibilityProductBlockUpdateStructureCostNumberTaskProperty); }
            set { SetValue(VisibilityProductBlockUpdateStructureCostNumberTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityStructureCostNumberOriginalUpdateStructureCostNumberTaskProperty = DependencyProperty.Register("VisibilityStructureCostNumberOriginalUpdateStructureCostNumberTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityStructureCostNumberOriginalUpdateStructureCostNumberTask
        {
            get { return (Visibility) GetValue(VisibilityStructureCostNumberOriginalUpdateStructureCostNumberTaskProperty); }
            set { SetValue(VisibilityStructureCostNumberOriginalUpdateStructureCostNumberTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityStructureCostNumberUpdateStructureCostNumberTaskProperty = DependencyProperty.Register("VisibilityStructureCostNumberUpdateStructureCostNumberTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityStructureCostNumberUpdateStructureCostNumberTask
        {
            get { return (Visibility) GetValue(VisibilityStructureCostNumberUpdateStructureCostNumberTaskProperty); }
            set { SetValue(VisibilityStructureCostNumberUpdateStructureCostNumberTaskProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityIsAcceptedUpdateStructureCostNumberTaskProperty = DependencyProperty.Register("VisibilityIsAcceptedUpdateStructureCostNumberTask", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsAcceptedUpdateStructureCostNumberTask
        {
            get { return (Visibility) GetValue(VisibilityIsAcceptedUpdateStructureCostNumberTaskProperty); }
            set { SetValue(VisibilityIsAcceptedUpdateStructureCostNumberTaskProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class ProductCategoryDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.ProductCategory).GetProperty(nameof(HVTApp.Model.POCOs.ProductCategory.IsStub)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityIsStubProductCategory = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityIsStubProductCategoryProperty = DependencyProperty.Register("VisibilityIsStubProductCategory", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityIsStubProductCategory
        {
            get { return (Visibility) GetValue(VisibilityIsStubProductCategoryProperty); }
            set { SetValue(VisibilityIsStubProductCategoryProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class ProductIncludedDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.ProductIncluded).GetProperty(nameof(HVTApp.Model.POCOs.ProductIncluded.ProductId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityProductIdProductIncluded = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityProductIdProductIncludedProperty = DependencyProperty.Register("VisibilityProductIdProductIncluded", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityProductIdProductIncluded
        {
            get { return (Visibility) GetValue(VisibilityProductIdProductIncludedProperty); }
            set { SetValue(VisibilityProductIdProductIncludedProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class StructureCostDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.StructureCost).GetProperty(nameof(HVTApp.Model.POCOs.StructureCost.OriginalStructureCostNumber)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityOriginalStructureCostNumberStructureCost = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.StructureCost).GetProperty(nameof(HVTApp.Model.POCOs.StructureCost.OriginalStructureCostProductBlock)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityOriginalStructureCostProductBlockStructureCost = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityOriginalStructureCostNumberStructureCostProperty = DependencyProperty.Register("VisibilityOriginalStructureCostNumberStructureCost", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityOriginalStructureCostNumberStructureCost
        {
            get { return (Visibility) GetValue(VisibilityOriginalStructureCostNumberStructureCostProperty); }
            set { SetValue(VisibilityOriginalStructureCostNumberStructureCostProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityOriginalStructureCostProductBlockStructureCostProperty = DependencyProperty.Register("VisibilityOriginalStructureCostProductBlockStructureCost", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityOriginalStructureCostProductBlockStructureCost
        {
            get { return (Visibility) GetValue(VisibilityOriginalStructureCostProductBlockStructureCostProperty); }
            set { SetValue(VisibilityOriginalStructureCostProductBlockStructureCostProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class TaskInvoiceForPaymentDetailsView : ViewBase
    {
        public TaskInvoiceForPaymentDetailsView()
        {
			InitializeComponent();
        }

        public TaskInvoiceForPaymentDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, TaskInvoiceForPaymentDetailsViewModel TaskInvoiceForPaymentDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = TaskInvoiceForPaymentDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.TaskInvoiceForPayment).GetProperty(nameof(HVTApp.Model.POCOs.TaskInvoiceForPayment.Items)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityItemsTaskInvoiceForPayment = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.TaskInvoiceForPayment).GetProperty(nameof(HVTApp.Model.POCOs.TaskInvoiceForPayment.MomentStart)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityMomentStartTaskInvoiceForPayment = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.TaskInvoiceForPayment).GetProperty(nameof(HVTApp.Model.POCOs.TaskInvoiceForPayment.MomentFinish)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityMomentFinishTaskInvoiceForPayment = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.TaskInvoiceForPayment).GetProperty(nameof(HVTApp.Model.POCOs.TaskInvoiceForPayment.MomentFinishByPlanMaker)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityMomentFinishByPlanMakerTaskInvoiceForPayment = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.TaskInvoiceForPayment).GetProperty(nameof(HVTApp.Model.POCOs.TaskInvoiceForPayment.BackManager)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityBackManagerTaskInvoiceForPayment = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.TaskInvoiceForPayment).GetProperty(nameof(HVTApp.Model.POCOs.TaskInvoiceForPayment.PlanMaker)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPlanMakerTaskInvoiceForPayment = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.TaskInvoiceForPayment).GetProperty(nameof(HVTApp.Model.POCOs.TaskInvoiceForPayment.OriginalIsRequired)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityOriginalIsRequiredTaskInvoiceForPayment = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.TaskInvoiceForPayment).GetProperty(nameof(HVTApp.Model.POCOs.TaskInvoiceForPayment.Comment)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityCommentTaskInvoiceForPayment = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.TaskInvoiceForPayment).GetProperty(nameof(HVTApp.Model.POCOs.TaskInvoiceForPayment.PlanMakerIsRequired)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPlanMakerIsRequiredTaskInvoiceForPayment = Visibility.Collapsed;


        }


        public static readonly DependencyProperty VisibilityItemsTaskInvoiceForPaymentProperty = DependencyProperty.Register("VisibilityItemsTaskInvoiceForPayment", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityItemsTaskInvoiceForPayment
        {
            get { return (Visibility) GetValue(VisibilityItemsTaskInvoiceForPaymentProperty); }
            set { SetValue(VisibilityItemsTaskInvoiceForPaymentProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityMomentStartTaskInvoiceForPaymentProperty = DependencyProperty.Register("VisibilityMomentStartTaskInvoiceForPayment", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityMomentStartTaskInvoiceForPayment
        {
            get { return (Visibility) GetValue(VisibilityMomentStartTaskInvoiceForPaymentProperty); }
            set { SetValue(VisibilityMomentStartTaskInvoiceForPaymentProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityMomentFinishTaskInvoiceForPaymentProperty = DependencyProperty.Register("VisibilityMomentFinishTaskInvoiceForPayment", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityMomentFinishTaskInvoiceForPayment
        {
            get { return (Visibility) GetValue(VisibilityMomentFinishTaskInvoiceForPaymentProperty); }
            set { SetValue(VisibilityMomentFinishTaskInvoiceForPaymentProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityMomentFinishByPlanMakerTaskInvoiceForPaymentProperty = DependencyProperty.Register("VisibilityMomentFinishByPlanMakerTaskInvoiceForPayment", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityMomentFinishByPlanMakerTaskInvoiceForPayment
        {
            get { return (Visibility) GetValue(VisibilityMomentFinishByPlanMakerTaskInvoiceForPaymentProperty); }
            set { SetValue(VisibilityMomentFinishByPlanMakerTaskInvoiceForPaymentProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityBackManagerTaskInvoiceForPaymentProperty = DependencyProperty.Register("VisibilityBackManagerTaskInvoiceForPayment", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityBackManagerTaskInvoiceForPayment
        {
            get { return (Visibility) GetValue(VisibilityBackManagerTaskInvoiceForPaymentProperty); }
            set { SetValue(VisibilityBackManagerTaskInvoiceForPaymentProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityPlanMakerTaskInvoiceForPaymentProperty = DependencyProperty.Register("VisibilityPlanMakerTaskInvoiceForPayment", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPlanMakerTaskInvoiceForPayment
        {
            get { return (Visibility) GetValue(VisibilityPlanMakerTaskInvoiceForPaymentProperty); }
            set { SetValue(VisibilityPlanMakerTaskInvoiceForPaymentProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityOriginalIsRequiredTaskInvoiceForPaymentProperty = DependencyProperty.Register("VisibilityOriginalIsRequiredTaskInvoiceForPayment", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityOriginalIsRequiredTaskInvoiceForPayment
        {
            get { return (Visibility) GetValue(VisibilityOriginalIsRequiredTaskInvoiceForPaymentProperty); }
            set { SetValue(VisibilityOriginalIsRequiredTaskInvoiceForPaymentProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityCommentTaskInvoiceForPaymentProperty = DependencyProperty.Register("VisibilityCommentTaskInvoiceForPayment", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityCommentTaskInvoiceForPayment
        {
            get { return (Visibility) GetValue(VisibilityCommentTaskInvoiceForPaymentProperty); }
            set { SetValue(VisibilityCommentTaskInvoiceForPaymentProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityPlanMakerIsRequiredTaskInvoiceForPaymentProperty = DependencyProperty.Register("VisibilityPlanMakerIsRequiredTaskInvoiceForPayment", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPlanMakerIsRequiredTaskInvoiceForPayment
        {
            get { return (Visibility) GetValue(VisibilityPlanMakerIsRequiredTaskInvoiceForPaymentProperty); }
            set { SetValue(VisibilityPlanMakerIsRequiredTaskInvoiceForPaymentProperty, value); OnPropertyChanged(); }
        }

	}

    public partial class TaskInvoiceForPaymentItemDetailsView : ViewBase
    {
        public TaskInvoiceForPaymentItemDetailsView()
        {
			InitializeComponent();
        }

        public TaskInvoiceForPaymentItemDetailsView(IRegionManager regionManager, IEventAggregator eventAggregator, TaskInvoiceForPaymentItemDetailsViewModel TaskInvoiceForPaymentItemDetailsViewModel) : base(regionManager, eventAggregator)
        {
            SetVisibilityProps();
			InitializeComponent();
            DataContext = TaskInvoiceForPaymentItemDetailsViewModel;
        }
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.TaskInvoiceForPaymentItem).GetProperty(nameof(HVTApp.Model.POCOs.TaskInvoiceForPaymentItem.TaskId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityTaskIdTaskInvoiceForPaymentItem = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.TaskInvoiceForPaymentItem).GetProperty(nameof(HVTApp.Model.POCOs.TaskInvoiceForPaymentItem.PriceEngineeringTask)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPriceEngineeringTaskTaskInvoiceForPaymentItem = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.TaskInvoiceForPaymentItem).GetProperty(nameof(HVTApp.Model.POCOs.TaskInvoiceForPaymentItem.TechnicalRequrements)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityTechnicalRequrementsTaskInvoiceForPaymentItem = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.TaskInvoiceForPaymentItem).GetProperty(nameof(HVTApp.Model.POCOs.TaskInvoiceForPaymentItem.PaymentCondition)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
        ...
        public static readonly DependencyProperty VisibilityTaskIdTaskInvoiceForPaymentItemProperty = DependencyProperty.Register("VisibilityTaskIdTaskInvoiceForPaymentItem", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityTaskIdTaskInvoiceForPaymentItem
        {
            get { return (Visibility) GetValue(VisibilityTaskIdTaskInvoiceForPaymentItemProperty); }
            set { SetValue(VisibilityTaskIdTaskInvoiceForPaymentItemProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityPriceEngineeringTaskTaskInvoiceForPaymentItemProperty = DependencyProperty.Register("VisibilityPriceEngineeringTaskTaskInvoiceForPaymentItem", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceEngineeringTaskTaskInvoiceForPaymentItem
        {
            get { return (Visibility) GetValue(VisibilityPriceEngineeringTaskTaskInvoiceForPaymentItemProperty); }
            set { SetValue(VisibilityPriceEngineeringTaskTaskInvoiceForPaymentItemProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityTechnicalRequrementsTaskInvoiceForPaymentItemProperty = DependencyProperty.Register("VisibilityTechnicalRequrementsTaskInvoiceForPaymentItem", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityTechnicalRequrementsTaskInvoiceForPaymentItem
        {
            get { return (Visibility) GetValue(VisibilityTechnicalRequrementsTaskInvoiceForPaymentItemProperty); }
            set { SetValue(VisibilityTechnicalRequrementsTaskInvoiceForPaymentItemProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityPaymentConditionTaskInvoiceForPaymentItemProperty = DependencyProperty.Register("VisibilityPaymentConditionTaskInvoiceForPaymentItem", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPaymentConditionTaskInvoiceForPaymentItem
        {
    ...
    public partial class TechnicalRequrementsDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.TechnicalRequrements).GetProperty(nameof(HVTApp.Model.POCOs.TechnicalRequrements.TaskId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityTaskIdTechnicalRequrements = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.TechnicalRequrements).GetProperty(nameof(HVTApp.Model.POCOs.TechnicalRequrements.PositionInTeamCenter)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPositionInTeamCenterTechnicalRequrements = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.TechnicalRequrements).GetProperty(nameof(HVTApp.Model.POCOs.TechnicalRequrements.Specification)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilitySpecificationTechnicalRequrements = Visibility.Collapsed;


        }


        public static readonly DependencyProperty VisibilityTaskIdTechnicalRequrementsProperty = DependencyProperty.Register("VisibilityTaskIdTechnicalRequrements", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityTaskIdTechnicalRequrements
        {
            get { return (Visibility) GetValue(VisibilityTaskIdTechnicalRequrementsProperty); }
            set { SetValue(VisibilityTaskIdTechnicalRequrementsProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityPositionInTeamCenterTechnicalRequrementsProperty = DependencyProperty.Register("VisibilityPositionInTeamCenterTechnicalRequrements", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPositionInTeamCenterTechnicalRequrements
        {
            get { return (Visibility) GetValue(VisibilityPositionInTeamCenterTechnicalRequrementsProperty); }
            set { SetValue(VisibilityPositionInTeamCenterTechnicalRequrementsProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilitySpecificationTechnicalRequrementsProperty = DependencyProperty.Register("VisibilitySpecificationTechnicalRequrements", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilitySpecificationTechnicalRequrements
        {
            get { return (Visibility) GetValue(VisibilitySpecificationTechnicalRequrementsProperty); }
            set { SetValue(VisibilitySpecificationTechnicalRequrementsProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class GlobalPropertiesDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.GlobalProperties).GetProperty(nameof(HVTApp.Model.POCOs.GlobalProperties.EmptyParameterCurrentTransformersSet)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityEmptyParameterCurrentTransformersSetGlobalProperties = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.GlobalProperties).GetProperty(nameof(HVTApp.Model.POCOs.GlobalProperties.ParameterCurrentTransformersSetCustom)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
        ...
        public static readonly DependencyProperty VisibilityEmptyParameterCurrentTransformersSetGlobalPropertiesProperty = DependencyProperty.Register("VisibilityEmptyParameterCurrentTransformersSetGlobalProperties", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityEmptyParameterCurrentTransformersSetGlobalProperties
        {
            get { return (Visibility) GetValue(VisibilityEmptyParameterCurrentTransformersSetGlobalPropertiesProperty); }
            set { SetValue(VisibilityEmptyParameterCurrentTransformersSetGlobalPropertiesProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityParameterCurrentTransformersSetCustomGlobalPropertiesProperty = DependencyProperty.Register("VisibilityParameterCurrentTransformersSetCustomGlobalProperties", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityParameterCurrentTransformersSetCustomGlobalProperties
        {
    ...
    public partial class NoteDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.Note).GetProperty(nameof(HVTApp.Model.POCOs.Note.ProjectId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityProjectIdNote = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityProjectIdNoteProperty = DependencyProperty.Register("VisibilityProjectIdNote", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityProjectIdNote
        {
            get { return (Visibility) GetValue(VisibilityProjectIdNoteProperty); }
            set { SetValue(VisibilityProjectIdNoteProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class OfferUnitDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.OfferUnit).GetProperty(nameof(HVTApp.Model.POCOs.OfferUnit.ProductId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityProductIdOfferUnit = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityProductIdOfferUnitProperty = DependencyProperty.Register("VisibilityProductIdOfferUnit", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityProductIdOfferUnit
        {
            get { return (Visibility) GetValue(VisibilityProductIdOfferUnitProperty); }
            set { SetValue(VisibilityProductIdOfferUnitProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class ProductBlockDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.ProductBlock).GetProperty(nameof(HVTApp.Model.POCOs.ProductBlock.StructureCostNumberIsRequired)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityStructureCostNumberIsRequiredProductBlock = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.ProductBlock).GetProperty(nameof(HVTApp.Model.POCOs.ProductBlock.LaborCosts)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityLaborCostsProductBlock = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.ProductBlock).GetProperty(nameof(HVTApp.Model.POCOs.ProductBlock.ParametersOrdered)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityParametersOrderedProductBlock = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityStructureCostNumberIsRequiredProductBlockProperty = DependencyProperty.Register("VisibilityStructureCostNumberIsRequiredProductBlock", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityStructureCostNumberIsRequiredProductBlock
        {
            get { return (Visibility) GetValue(VisibilityStructureCostNumberIsRequiredProductBlockProperty); }
            set { SetValue(VisibilityStructureCostNumberIsRequiredProductBlockProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityLaborCostsProductBlockProperty = DependencyProperty.Register("VisibilityLaborCostsProductBlock", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityLaborCostsProductBlock
        {
            get { return (Visibility) GetValue(VisibilityLaborCostsProductBlockProperty); }
            set { SetValue(VisibilityLaborCostsProductBlockProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityParametersOrderedProductBlockProperty = DependencyProperty.Register("VisibilityParametersOrderedProductBlock", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityParametersOrderedProductBlock
        {
            get { return (Visibility) GetValue(VisibilityParametersOrderedProductBlockProperty); }
            set { SetValue(VisibilityParametersOrderedProductBlockProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class CompanyDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.Company).GetProperty(nameof(HVTApp.Model.POCOs.Company.Email)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityEmailCompany = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityEmailCompanyProperty = DependencyProperty.Register("VisibilityEmailCompany", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityEmailCompany
        {
            get { return (Visibility) GetValue(VisibilityEmailCompanyProperty); }
            set { SetValue(VisibilityEmailCompanyProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class ContractDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.Contract).GetProperty(nameof(HVTApp.Model.POCOs.Contract.ContragentEmployee)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityContragentEmployeeContract = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityContragentEmployeeContractProperty = DependencyProperty.Register("VisibilityContragentEmployeeContract", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityContragentEmployeeContract
        {
            get { return (Visibility) GetValue(VisibilityContragentEmployeeContractProperty); }
            set { SetValue(VisibilityContragentEmployeeContractProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class ParameterGroupDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.ParameterGroup).GetProperty(nameof(HVTApp.Model.POCOs.ParameterGroup.Powerful)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPowerfulParameterGroup = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityPowerfulParameterGroupProperty = DependencyProperty.Register("VisibilityPowerfulParameterGroup", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPowerfulParameterGroup
        {
            get { return (Visibility) GetValue(VisibilityPowerfulParameterGroupProperty); }
            set { SetValue(VisibilityPowerfulParameterGroupProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class SalesUnitDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.SalesUnit).GetProperty(nameof(HVTApp.Model.POCOs.SalesUnit.FacilityId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityFacilityIdSalesUnit = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.SalesUnit).GetProperty(nameof(HVTApp.Model.POCOs.SalesUnit.ProductId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityProductIdSalesUnit = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.SalesUnit).GetProperty(nameof(HVTApp.Model.POCOs.SalesUnit.CostWithReserve)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityCostWithReserveSalesUnit = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.SalesUnit).GetProperty(nameof(HVTApp.Model.POCOs.SalesUnit.PaymentConditionSetId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPaymentConditionSetIdSalesUnit = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.SalesUnit).GetProperty(nameof(HVTApp.Model.POCOs.SalesUnit.ProjectId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityProjectIdSalesUnit = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.SalesUnit).GetProperty(nameof(HVTApp.Model.POCOs.SalesUnit.FirstPaymentDate)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityFirstPaymentDateSalesUnit = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.SalesUnit).GetProperty(nameof(HVTApp.Model.POCOs.SalesUnit.PaidSum)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPaidSumSalesUnit = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityFacilityIdSalesUnitProperty = DependencyProperty.Register("VisibilityFacilityIdSalesUnit", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityFacilityIdSalesUnit
        {
            get { return (Visibility) GetValue(VisibilityFacilityIdSalesUnitProperty); }
            set { SetValue(VisibilityFacilityIdSalesUnitProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityProductIdSalesUnitProperty = DependencyProperty.Register("VisibilityProductIdSalesUnit", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityProductIdSalesUnit
        {
            get { return (Visibility) GetValue(VisibilityProductIdSalesUnitProperty); }
            set { SetValue(VisibilityProductIdSalesUnitProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityCostWithReserveSalesUnitProperty = DependencyProperty.Register("VisibilityCostWithReserveSalesUnit", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityCostWithReserveSalesUnit
        {
            get { return (Visibility) GetValue(VisibilityCostWithReserveSalesUnitProperty); }
            set { SetValue(VisibilityCostWithReserveSalesUnitProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityPaymentConditionSetIdSalesUnitProperty = DependencyProperty.Register("VisibilityPaymentConditionSetIdSalesUnit", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPaymentConditionSetIdSalesUnit
        {
            get { return (Visibility) GetValue(VisibilityPaymentConditionSetIdSalesUnitProperty); }
            set { SetValue(VisibilityPaymentConditionSetIdSalesUnitProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityProjectIdSalesUnitProperty = DependencyProperty.Register("VisibilityProjectIdSalesUnit", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityProjectIdSalesUnit
        {
            get { return (Visibility) GetValue(VisibilityProjectIdSalesUnitProperty); }
            set { SetValue(VisibilityProjectIdSalesUnitProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityPriceCalculationItemsSalesUnitProperty = DependencyProperty.Register("VisibilityPriceCalculationItemsSalesUnit", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceCalculationItemsSalesUnit
        {
            get { return (Visibility) GetValue(VisibilityPriceCalculationItemsSalesUnitProperty); }
            set { SetValue(VisibilityPriceCalculationItemsSalesUnitProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityFirstPaymentDateSalesUnitProperty = DependencyProperty.Register("VisibilityFirstPaymentDateSalesUnit", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityFirstPaymentDateSalesUnit
        {
            get { return (Visibility) GetValue(VisibilityFirstPaymentDateSalesUnitProperty); }
            set { SetValue(VisibilityFirstPaymentDateSalesUnitProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityPaidSumSalesUnitProperty = DependencyProperty.Register("VisibilityPaidSumSalesUnit", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPaidSumSalesUnit
        {
            get { return (Visibility) GetValue(VisibilityPaidSumSalesUnitProperty); }
            set { SetValue(VisibilityPaidSumSalesUnitProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class DocumentDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.Document).GetProperty(nameof(HVTApp.Model.POCOs.Document.WhoRegisteredUserId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityWhoRegisteredUserIdDocument = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.Document).GetProperty(nameof(HVTApp.Model.POCOs.Document.WhoRegisteredUser)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityWhoRegisteredUserDocument = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityWhoRegisteredUserIdDocumentProperty = DependencyProperty.Register("VisibilityWhoRegisteredUserIdDocument", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityWhoRegisteredUserIdDocument
        {
            get { return (Visibility) GetValue(VisibilityWhoRegisteredUserIdDocumentProperty); }
            set { SetValue(VisibilityWhoRegisteredUserIdDocumentProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityWhoRegisteredUserDocumentProperty = DependencyProperty.Register("VisibilityWhoRegisteredUserDocument", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityWhoRegisteredUserDocument
        {
            get { return (Visibility) GetValue(VisibilityWhoRegisteredUserDocumentProperty); }
            set { SetValue(VisibilityWhoRegisteredUserDocumentProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class OfferDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.Offer).GetProperty(nameof(HVTApp.Model.POCOs.Offer.OfferUnits)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityOfferUnitsOffer = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.Offer).GetProperty(nameof(HVTApp.Model.POCOs.Offer.WhoRegisteredUserId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityWhoRegisteredUserIdOffer = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.Offer).GetProperty(nameof(HVTApp.Model.POCOs.Offer.WhoRegisteredUser)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityWhoRegisteredUserOffer = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityOfferUnitsOfferProperty = DependencyProperty.Register("VisibilityOfferUnitsOffer", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityOfferUnitsOffer
        {
            get { return (Visibility) GetValue(VisibilityOfferUnitsOfferProperty); }
            set { SetValue(VisibilityOfferUnitsOfferProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityWhoRegisteredUserIdOfferProperty = DependencyProperty.Register("VisibilityWhoRegisteredUserIdOffer", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityWhoRegisteredUserIdOffer
        {
            get { return (Visibility) GetValue(VisibilityWhoRegisteredUserIdOfferProperty); }
            set { SetValue(VisibilityWhoRegisteredUserIdOfferProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityWhoRegisteredUserOfferProperty = DependencyProperty.Register("VisibilityWhoRegisteredUserOffer", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityWhoRegisteredUserOffer
        {
            get { return (Visibility) GetValue(VisibilityWhoRegisteredUserOfferProperty); }
            set { SetValue(VisibilityWhoRegisteredUserOfferProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class ProjectDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.Project).GetProperty(nameof(HVTApp.Model.POCOs.Project.ProjectTypeId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityProjectTypeIdProject = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.Project).GetProperty(nameof(HVTApp.Model.POCOs.Project.ManagerId)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityManagerIdProject = Visibility.Collapsed;
            ...
            //attr = typeof(HVTApp.Model.POCOs.Project).GetProperty(nameof(HVTApp.Model.POCOs.Project.SalesUnits)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilitySalesUnitsProject = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityProjectTypeIdProjectProperty = DependencyProperty.Register("VisibilityProjectTypeIdProject", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityProjectTypeIdProject
        {
            get { return (Visibility) GetValue(VisibilityProjectTypeIdProjectProperty); }
            set { SetValue(VisibilityProjectTypeIdProjectProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilityManagerIdProjectProperty = DependencyProperty.Register("VisibilityManagerIdProject", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityManagerIdProject
        {
            get { return (Visibility) GetValue(VisibilityManagerIdProjectProperty); }
            set { SetValue(VisibilityManagerIdProjectProperty, value); OnPropertyChanged(); }
        }
        ...
        public static readonly DependencyProperty VisibilitySalesUnitsProjectProperty = DependencyProperty.Register("VisibilitySalesUnitsProject", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilitySalesUnitsProject
        {
            get { return (Visibility) GetValue(VisibilitySalesUnitsProjectProperty); }
            set { SetValue(VisibilitySalesUnitsProjectProperty, value); OnPropertyChanged(); }
        }
    ...
    public partial class SpecificationDetailsView : ViewBase
    {
        ...
        private void SetVisibilityProps()
        {
            ...
            //attr = typeof(HVTApp.Model.POCOs.Specification).GetProperty(nameof(HVTApp.Model.POCOs.Specification.PriceEngineeringTasks)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityPriceEngineeringTasksSpecification = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.Specification).GetProperty(nameof(HVTApp.Model.POCOs.Specification.TechnicalRequrements)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilityTechnicalRequrementsSpecification = Visibility.Collapsed;

            //attr = typeof(HVTApp.Model.POCOs.Specification).GetProperty(nameof(HVTApp.Model.POCOs.Specification.SalesUnits)).GetCustomAttribute<NotUpdateAttribute>();
            //if (attr != null && attr.RolesCantUpdate.Contains(CommonOptions.User.RoleCurrent))
            //    VisibilitySalesUnitsSpecification = Visibility.Collapsed;
        ...
        public static readonly DependencyProperty VisibilityPriceEngineeringTasksSpecificationProperty = DependencyProperty.Register("VisibilityPriceEngineeringTasksSpecification", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityPriceEngineeringTasksSpecification
        {
            get { return (Visibility) GetValue(VisibilityPriceEngineeringTasksSpecificationProperty); }
            set { SetValue(VisibilityPriceEngineeringTasksSpecificationProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilityTechnicalRequrementsSpecificationProperty = DependencyProperty.Register("VisibilityTechnicalRequrementsSpecification", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilityTechnicalRequrementsSpecification
        {
            get { return (Visibility) GetValue(VisibilityTechnicalRequrementsSpecificationProperty); }
            set { SetValue(VisibilityTechnicalRequrementsSpecificationProperty, value); OnPropertyChanged(); }
        }


        public static readonly DependencyProperty VisibilitySalesUnitsSpecificationProperty = DependencyProperty.Register("VisibilitySalesUnitsSpecification", typeof(Visibility), typeof(ProjectDetailsView), new PropertyMetadata((System.Windows.Visibility.Visible)));
        public Visibility VisibilitySalesUnitsSpecification
        {
            get { return (Visibility) GetValue(VisibilitySalesUnitsSpecificationProperty); }
            set { SetValue(VisibilitySalesUnitsSpecificationProperty, value); OnPropertyChanged(); }
        }
