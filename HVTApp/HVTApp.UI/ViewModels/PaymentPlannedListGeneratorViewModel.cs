...
{
    //public class PaymentPlannedListGeneratorViewModel : BaseListViewModel<Payment, PaymentLookup, AfterSavePaymentEvent, AfterSelectPaymentEvent, AfterRemovePaymentEvent, PaymentLookupDataService>
    //{
    ...
    //    {
    //        var newPayment = new Payment {Date = SelectedPayment.Date};
