...
namespace HVTApp.UI.ViewModels
{
    ...
    public partial class CalculatePriceTaskDetailsViewModel : BaseDetailsViewModel<CalculatePriceTaskWrapper, CalculatePriceTask, AfterSaveCalculatePriceTaskEvent>
    {
        ...
        public CalculatePriceTaskDetailsViewModel(IUnityContainer container) : base(container) 
		{
			...
			if (_getEntitiesForAddInProjectsCommand == null) _getEntitiesForAddInProjectsCommand = async () => { return await UnitOfWork.Repository<Project>().GetAllAsync(); };;
			...
			if (_getEntitiesForAddInOffersCommand == null) _getEntitiesForAddInOffersCommand = async () => { return await UnitOfWork.Repository<Offer>().GetAllAsync(); };;
			...
			if (_getEntitiesForAddInSpecificationsCommand == null) _getEntitiesForAddInSpecificationsCommand = async () => { return await UnitOfWork.Repository<Specification>().GetAllAsync(); };;
