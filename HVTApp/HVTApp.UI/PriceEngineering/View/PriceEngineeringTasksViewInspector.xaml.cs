...
namespace HVTApp.UI.PriceEngineering.View
{
    ...
    public partial class PriceEngineeringTasksViewInspector : IDisposable
    {
        private TasksViewModelInspector _viewModel;

        public PriceEngineeringTasksViewInspector(TasksViewModelInspector viewModel, IUnityContainer container, IRegionManager regionManager, IEventAggregator eventAggregator) : base(container, regionManager, eventAggregator)
        {
