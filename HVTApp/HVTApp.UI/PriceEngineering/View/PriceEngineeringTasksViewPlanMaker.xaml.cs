...
{
    [RibbonTab(typeof(TabPriceEngineeringTaskBackManager))]
    public partial class PriceEngineeringTasksViewPlanMaker : IDisposable
    {
        private TasksViewModelPlanMaker _viewModel;

        public PriceEngineeringTasksViewPlanMaker(TasksViewModelPlanMaker viewModel, IUnityContainer container, IRegionManager regionManager, IEventAggregator eventAggregator) : base(container, regionManager, eventAggregator)
        {
