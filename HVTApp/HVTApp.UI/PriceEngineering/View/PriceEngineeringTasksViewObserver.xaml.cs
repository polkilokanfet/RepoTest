...
{
    [RibbonTab(typeof(TabPriceEngineeringTaskObserver))]
    public partial class PriceEngineeringTasksViewObserver : IDisposable
    {
        private TasksViewModelObserver _viewModel;

        public PriceEngineeringTasksViewObserver(TasksViewModelObserver viewModel, IUnityContainer container, IRegionManager regionManager, IEventAggregator eventAggregator) : base(container, regionManager, eventAggregator)
        {
