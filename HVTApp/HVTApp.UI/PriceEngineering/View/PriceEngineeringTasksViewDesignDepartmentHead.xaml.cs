...
namespace HVTApp.UI.PriceEngineering.View
{
    ...
    public partial class PriceEngineeringTasksViewDesignDepartmentHead : IDisposable
    {
        private TasksViewModelDesignDepartmentHead _viewModel;

        public PriceEngineeringTasksViewDesignDepartmentHead(TasksViewModelDesignDepartmentHead viewModel, IUnityContainer container, IRegionManager regionManager, IEventAggregator eventAggregator) : base(container, regionManager, eventAggregator)
        {
