...
namespace HVTApp.UI.PriceEngineering
{
    ...
    public partial class PriceCalculationSettingsView
    {
        private readonly PriceCalculationViewModel _viewModel;
        public PriceCalculationSettingsView(PriceCalculationViewModel viewModel, IRegionManager regionManager, IEventAggregator eventAggregator) : base(regionManager, eventAggregator)
        {
            InitializeComponent();
