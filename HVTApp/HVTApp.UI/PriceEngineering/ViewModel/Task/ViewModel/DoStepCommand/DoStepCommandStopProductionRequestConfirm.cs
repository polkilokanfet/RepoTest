...
namespace HVTApp.UI.PriceEngineering.DoStepCommand
{
    ...
    public class DoStepCommandStopProductionRequestConfirm : DoStepCommand<TaskViewModelBackManagerBoss>
    {
        ...
        {
            yield return new NotificationAboutPriceEngineeringTaskEventArg(this.ViewModel.Model, Manager, Role.SalesManager, $"ѕроизводство остановлено: {ViewModel.Model}");
        }
