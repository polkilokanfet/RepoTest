...
namespace HVTApp.UI.PriceEngineering.DoStepCommand
{
    ...
    public class DoStepCommandStopProductionRequestReject : DoStepCommand<TaskViewModelBackManagerBoss>
    {
        ...
        {
            yield return new NotificationAboutPriceEngineeringTaskEventArg(this.ViewModel.Model, Manager, Role.SalesManager, $"Запрос на остановку производства отклонен: {ViewModel.Model}");
        }
