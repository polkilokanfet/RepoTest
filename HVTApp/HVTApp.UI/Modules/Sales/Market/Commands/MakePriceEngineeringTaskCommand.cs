...
{
    public class MakePriceEngineeringTaskCommand : DelegateLogCommand
    {
        private readonly Market2ViewModel _viewModel;
        private readonly IUnitOfWork _unitOfWork;
        private readonly IRegionManager _regionManager;

        public MakePriceEngineeringTaskCommand(Market2ViewModel viewModel, IUnitOfWork unitOfWork, IRegionManager regionManager)
        {
