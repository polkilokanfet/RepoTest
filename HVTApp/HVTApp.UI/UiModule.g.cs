...
namespace HVTApp.UI
{
    public partial class UiModule : ModuleBase
    {
		private void RegisterViews()
        {
            ...
            _updateDetailsService.Register<DesignDepartment, DesignDepartmentDetailsView>();
            ...
            Container.RegisterViewForNavigation<DesignDepartmentParametersLookupListView>();
            ...
            Container.RegisterViewForNavigation<DesignDepartmentParametersSubTaskLookupListView>();
            ...
            _updateDetailsService.Register<PriceEngineeringTask, PriceEngineeringTaskDetailsView>();
            Container.RegisterViewForNavigation<PriceEngineeringTaskFileAnswerLookupListView>();
            //_dialogService.Register<PriceEngineeringTaskFileAnswerDetailsViewModel, PriceEngineeringTaskFileAnswerDetailsView>();
			_selectService.Register<PriceEngineeringTaskFileAnswerLookupListView, PriceEngineeringTaskFileAnswer>();
            _updateDetailsService.Register<PriceEngineeringTaskFileAnswer, PriceEngineeringTaskFileAnswerDetailsView>();
            Container.RegisterViewForNavigation<PriceEngineeringTaskFileTechnicalRequirementsLookupListView>();
            //_dialogService.Register<PriceEngineeringTaskFileTechnicalRequirementsDetailsViewModel, PriceEngineeringTaskFileTechnicalRequirementsDetailsView>();
			_selectService.Register<PriceEngineeringTaskFileTechnicalRequirementsLookupListView, PriceEngineeringTaskFileTechnicalRequirements>();
            _updateDetailsService.Register<PriceEngineeringTaskFileTechnicalRequirements, PriceEngineeringTaskFileTechnicalRequirementsDetailsView>();
            Container.RegisterViewForNavigation<PriceEngineeringTaskMessageLookupListView>();
            //_dialogService.Register<PriceEngineeringTaskMessageDetailsViewModel, PriceEngineeringTaskMessageDetailsView>();
			_selectService.Register<PriceEngineeringTaskMessageLookupListView, PriceEngineeringTaskMessage>();
            _updateDetailsService.Register<PriceEngineeringTaskMessage, PriceEngineeringTaskMessageDetailsView>();
            Container.RegisterViewForNavigation<PriceEngineeringTaskProductBlockAddedLookupListView>();
