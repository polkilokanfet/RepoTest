...
namespace HVTApp.UI
{
    public partial class UiModule : ModuleBase
    {
		private void RegisterViews()
        {
            ...
            Container.RegisterViewForNavigation<CostsPercentsLookupListView>();
            //_dialogService.Register<CostsPercentsDetailsViewModel, CostsPercentsDetailsView>();
			_selectService.Register<CostsPercentsLookupListView, CostsPercents>();
            _updateDetailsService.Register<CostsPercents, CostsPercentsDetailsView>();
            ...
            Container.RegisterViewForNavigation<LaborHourCostLookupListView>();
            //_dialogService.Register<LaborHourCostDetailsViewModel, LaborHourCostDetailsView>();
			_selectService.Register<LaborHourCostLookupListView, LaborHourCost>();
            _updateDetailsService.Register<LaborHourCost, LaborHourCostDetailsView>();

            Container.RegisterViewForNavigation<LaborHoursLookupListView>();
            ...
            Container.RegisterViewForNavigation<PriceCalculationHistoryItemLookupListView>();
            //_dialogService.Register<PriceCalculationHistoryItemDetailsViewModel, PriceCalculationHistoryItemDetailsView>();
			_selectService.Register<PriceCalculationHistoryItemLookupListView, PriceCalculationHistoryItem>();
            _updateDetailsService.Register<PriceCalculationHistoryItem, PriceCalculationHistoryItemDetailsView>();
