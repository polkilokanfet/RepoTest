        ...
        public PriceCalculationsViewModel(IUnityContainer container) : base(container)
        {
            ...
            RemoveCalculationCommand = new DelegateCommand(
                () =>
                {
                    ...
                    var result = messageService.ShowYesNoMessageDialog("”даление", "ƒействительно хотите удалить из расчет ѕ«?", defaultNo:true);
                    ...
                    {
                        messageService.ShowOkMessageDialog("”даление", "¬ы не можете удалить некоторые строки в расчете, т.к. они размещены в производстве.");
                    }
                    else
                    {
