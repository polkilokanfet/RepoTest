...
namespace HVTApp.Model.Wrapper
{
  public partial class ProductsGroup`1Wrapper : WrapperBase<ProductsGroup`1>
  {
	...
	public static ProductsGroup`1Wrapper GetWrapper()
	{
		return GetWrapper(new ProductsGroup`1());
	}
    ...
    public IValidatableChangeTrackingCollection<TProductWrapper> Products { get; private set; }
