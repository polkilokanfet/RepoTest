...
namespace HVTApp.Model.Wrapper
{
  ...
  {
    public TenderWrapper() : base(new Tender()) { }
    ...
    public TenderWrapper(Tender model, IDictionary<IBaseEntity, object> dictionary) : base(model, new ExistsWrappers(dictionary)) { }
