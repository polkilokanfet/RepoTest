...
namespace HVTApp.Model.Wrapper
{
  public partial class TechLinkWrapper : WrapperBase<TechLink>
  {
	...
	public static TechLinkWrapper GetWrapper()
	{
		return GetWrapper(new TechLink());
	}
    ...
    public IValidatableChangeTrackingCollection<TechLinkWrapper> ChildLinks { get; private set; }
