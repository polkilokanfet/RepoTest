...
namespace HVTApp.Infrastructure.Behaviors
{
    public static class DataGridChangeBehavior
    {
        ...
        {
            IsActiveProperty = DependencyProperty.RegisterAttached("IsActive", 
                typeof(bool), typeof(DataGridChangeBehavior), 
        ...
        private static void AddSetters(Style style, string bindingPath, DataGrid dataGrid)
        {
            ...
            style.Setters.Add(new Setter(Validation.ErrorTemplateProperty,
                dataGrid.FindResource("InsideValidationErrorTemplate")));
        }
    }
}
